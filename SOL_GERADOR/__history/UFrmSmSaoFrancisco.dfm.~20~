inherited FrmSmSaoFrancisco: TFrmSmSaoFrancisco
  Caption = 'SM SAO FRANCISCO'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited PctArquivos: TPageControl
    ...
    inherited AbaProdutos: TTabSheet
      ...
      object btnInsertMarca: TButton
        Left = 153
        Top = 67
        Width = 92
        Height = 25
        Caption = 'INSERT marca'
        Enabled = False
        TabOrder = 17
        OnClick = btnInsertMarcaClick
      end
      object btnUpdateMarca: TButton
        Left = 153
        Top = 96
        Width = 92
        Height = 25
        Caption = 'UPDATE marca'
        Enabled = False
        TabOrder = 18
        OnClick = btnUpdateMarcaClick
      end
    end
  ...
  object ADOMySQL: TADOConnection
    ConnectionString = 
      ...
      'D=root;Data Source=predileto_l1'
    LoginPrompt = False
    Provider = 'MSDASQL.1'
    Left = 576
    Top = 8
