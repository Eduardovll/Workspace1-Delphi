...
//
      ...
      //INICIO - ABAIXO - CRIADO EXCLUSIVAMENTE PARA CONVERSAO SM ZEU APAGAR APÓS USO [14/07/2022]
      //SQL.Clear;
      //SQL.Add('UPDATE AGENTES');
      ...
      //except
      //end;
      //FIM - ABAIXO - CRIADO EXCLUSIVAMENTE PARA CONVERSAO SM ZEU APAGAR APÓS USO [14/07/2022]
//
  end;
