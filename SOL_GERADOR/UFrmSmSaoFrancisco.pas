...
type
  TFrmSmSaoFrancisco = class(TFrmModeloSis)
    CbxLoja: TComboBox;
    lblLoja: TLabel;
    ...
    btnInsertMarca: TButton;
    btnUpdateMarca: TButton;
    Label12: TLabel;
    ...
    procedure btnUpdateMarcaClick(Sender: TObject);
  ...
  public
    ...
    procedure GeraInsertMarca;
    procedure GeraUpdateMarca;

  end;

var
  FrmSmSaoFrancisco: TFrmSmSaoFrancisco;
  ListNCM    : TStringList;
  TotalCont  : Integer;
  NumLinha : Integer;
  Arquivo: TextFile;
  ...
  FlgGeraInsertMarca : Boolean = False;
  FlgGeraUpdateMarca : Boolean = False;
...
procedure TFrmSmSaoFrancisco.GerarProducao;
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GerarProduto;
begin
  inherited;

  if FlgGeraUpdateMarca then
  begin
    GeraUpdateMarca;
    Exit;
  end;
...
//     SQL.Add('          WHEN PRODUTOS.CODBARRA_PRODUTOS = 0 THEN PRODUTOS.CODPROD_PRODUTOS  ');
     SQL.Add('   	      ELSE PRODUTOS.CODBARRA_PRODUTOS      ');
     SQL.Add('   	   END AS COD_BARRA_PRINCIPAL,      ');
     SQL.Add('          ');
     SQL.Add('       UPPER(PRODUTOS.DESCRICAO_PRODUTOS) AS DES_REDUZIDA,      ');
     SQL.Add('       UPPER(PRODUTOS.DESCRICAO_PRODUTOS) AS DES_PRODUTO,      ');
     ...
     SQL.Add('       COALESCE(PRODUTOS.CODIGOSETOR, 999) AS COD_SECAO,   ');
     SQL.Add('       COALESCE(PRODUTOS.CODGRU_PRODUTOS, 999) AS COD_GRUPO,   ');
     SQL.Add('       COALESCE(PRODUTOS.SUBGRUPO, 999) AS COD_SUB_GRUPO,    ');
     SQL.Add('       COALESCE(PRODUTOS.CODFAMILIA, 0) AS COD_PRODUTO_SIMILAR,      ');
     SQL.Add('             ');
     SQL.Add('       CASE      ');
     ...
     SQL.Add('       CASE      ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''05'' THEN ''S''      ');
     SQL.Add('           WHEN PRODUTOS.STPIS IS NULL THEN ''S''      ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''49'' THEN ''S''      ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''06'' THEN ''S''   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''01'' THEN ''N''   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''07'' THEN ''S''   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''04'' THEN ''S''   ');
     SQL.Add('           ELSE ''N''        ');
     ...
     SQL.Add('             ');
     SQL.Add('       CASE      ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''05'' THEN 2     ');
     SQL.Add('           WHEN PRODUTOS.STPIS IS NULL THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''49'' THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''06'' THEN 0   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''01'' THEN -1   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''07'' THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.STPIS = ''04'' THEN 1   ');
     SQL.Add('           ELSE -1       ');
     SQL.Add('       END AS TIPO_NAO_PIS_COFINS,      ');
     SQL.Add('       0 AS TIPO_EVENTO,      ');
     SQL.Add('       0 AS COD_ASSOCIADO,      ');
     SQL.Add('       '''' AS DES_OBSERVACAO,      ');
     SQL.Add('       COALESCE(NUTRI.CODIGO, 0) AS COD_INFO_NUTRICIONAL,      ');
     SQL.Add('       COALESCE(PRODUTOS.NAT_REC_PIS, 999) AS COD_TAB_SPED,      ');
     SQL.Add('             ');
     ...
     SQL.Add('   LEFT JOIN CE_INFONUTRI AS NUTRI ON NUTRI.CODIGO = PRODUTOS.CODPROD_PRODUTOS      ');
...
procedure TFrmSmSaoFrancisco.GerarReceitas;
begin
  inherited;
...
//     SQL.Add('          ');
//     SQL.Add('       CASE   ');
//     SQL.Add('           WHEN RECEITAS.OBSERVACAO IS NULL THEN 0    ');
//     SQL.Add('   		ELSE PRODUTOS.CODPROD_PRODUTOS   ');
//     SQL.Add('   	END AS COD_INFO_RECEITA,    ');
//     SQL.Add('          ');
//     SQL.Add('       COALESCE(RECEITAS.OBSERVACAO, ''A DEFINIR'') AS DES_INFO_RECEITA,   ');
//     SQL.Add('      ');
//     SQL.Add('       COALESCE(   ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO1, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO2, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO3, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO4, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO5, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO6, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO7, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO8, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO9, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO10, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO11, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO12, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO13, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO14, CHAR(13) + CHAR(10), '''' ) +    ');
//     SQL.Add('       REPLACE(RECEITAS.CAMPO15, CHAR(13) + CHAR(10), '''' ), ''A DEFINIR'') AS DETALHAMENTO   ');
//     SQL.Add('          ');
//     SQL.Add('       -- ''MASTER'' AS USUARIO,   ');
//     SQL.Add('       -- ''26-11-2020'' AS DTA_ALTERACAO,   ');
//     SQL.Add('       -- ''26-11-2020'' AS DTA_CADASTRO       ');
//     SQL.Add('   FROM      ');
//     SQL.Add('       CE_PRODUTOS AS PRODUTOS      ');
//     SQL.Add('   LEFT JOIN CE_INFOEXTRA AS RECEITAS ON RECEITAS.CODIGO = PRODUTOS.CODPROD_PRODUTOS   ');
...
procedure TFrmSmSaoFrancisco.GerarSecao;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       CE_PRODUTOS AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CE_SETORES AS SECAO ON SECAO.CODIGO = PRODUTOS.CODIGOSETOR   ');
...
procedure TFrmSmSaoFrancisco.GerarSubGrupo;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(PRODUTOS.CODGRU_PRODUTOS, 999) AS COD_GRUPO,   ');
     SQL.Add('       COALESCE(PRODUTOS.SUBGRUPO, 999) AS COD_SUB_GRUPO,   ');
     SQL.Add('       COALESCE(SUBGRUPOS.DESCRICAO, ''A DEFINIR'') AS DES_SUB_GRUPO,   ');
     SQL.Add('       0 AS VAL_META,   ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       CE_PRODUTOS AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN SUBGRUPOS ON SUBGRUPOS.CODIGO = PRODUTOS.SUBGRUPO   ');
...
procedure TFrmSmSaoFrancisco.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmSaoFrancisco.GerarVenda;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT DISTINCT           ');
     SQL.Add('       CASE WHEN PRODUTOS.CODPROD_PRODUTOS = ''111404'' THEN ''1000970'' ELSE PRODUTOS.CODPROD_PRODUTOS END AS COD_PRODUTO,      ');
     SQL.Add('       VENDAS.CODEMPRESA AS COD_LOJA,      ');
     SQL.Add('       0 IND_TIPO,      ');
     SQL.Add('       VENDAS.CAIXA_MOV AS NUM_PDV,      ');
     SQL.Add('       VENDAS.QTD_MOV AS QTD_TOTAL_PRODUTO,      ');
     SQL.Add('       (VENDAS.VENDA_MOV + VENDAS.VLACRDESC) AS VAL_TOTAL_PRODUTO,      ');
...
//     SQL.Add('   	(SUBSTRING(CONVERT(VARCHAR, DATA_MOV, 105), 4, 2) + ''/'' +   ');
//     SQL.Add('   	SUBSTRING(CONVERT(VARCHAR, DATA_MOV, 105), 1, 2) + ''/'' + 	    ');
//     SQL.Add('   	SUBSTRING(CONVERT(VARCHAR, DATA_MOV, 105), 7, 4)) AS DTA_SAIDA,  ');
     SQL.Add('       DATA_MOV AS DTA_SAIDA, ');
     SQL.Add('       CASE      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''FEB'' THEN ''02'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''APR'' THEN ''04'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''MAY'' THEN ''05'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''AUG'' THEN ''08'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''SEP'' THEN ''09'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''OCT'' THEN ''10'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')      ');
     ...
     SQL.Add('           WHEN REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 3,5)), '' '', '''') = ''DEC'' THEN ''12'' + REPLACE(LTRIM(SUBSTRING(CONVERT(VARCHAR, VENDAS.DATA, 106), 7,10)), '' '', '''')     ');
     ...
     SQL.Add('             ');
     SQL.Add('       CASE       ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 12 THEN 3   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 7 THEN 2   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 18 THEN 4   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 90 THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 99 THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS IS NULL THEN 22   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 11 THEN 35   ');
     SQL.Add('           WHEN PRODUTOS.CODMOD_PRODUTOS = 8 THEN 24   ');
     SQL.Add('           ELSE 22     ');
...
procedure TFrmSmSaoFrancisco.GeraUpdateMarca;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
  begin
    ...
    SQL.Add('   SELECT   ');
    SQL.Add('   	CODPROD_PRODUTOS AS COD_PRODUTO,   ');
    SQL.Add('   	CODMAR_PRODUTOS AS COD_PRODUTO_ANT   ');
    SQL.Add('   FROM   ');
    SQL.Add('   	CE_PRODUTOS   ');
    ...
    begin
      try
        ...
        Writeln(Arquivo, 'UPDATE TAB_PRODUTO SET COD_MARCA = '''+QryPrincipal2.FieldByName('COD_PRODUTO_ANT').AsString+''' WHERE COD_PRODUTO = '+COD_PRODUTO+' ; ');
...
procedure TFrmSmSaoFrancisco.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmSaoFrancisco.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmSaoFrancisco.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.BtnGerarClick(Sender: TObject);
begin
...
//
   ...
   if FlgGeraUpdateMarca then
   begin
     AssignFile(Arquivo, EdtCamArquivo.Text + '\SCRIPT_ATUALIZA_MARCA.TXT' );
     Rewrite(Arquivo);
...
procedure TFrmSmSaoFrancisco.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.btnInsertMarcaClick(Sender: TObject);
begin
  inherited;
  FlgGeraInsertMarca := True;
  BtnGerar.Click;
  FlgGeraInsertMarca := False;
end;

procedure TFrmSmSaoFrancisco.btnUpdateMarcaClick(Sender: TObject);
begin
  inherited;
  FlgGeraUpdateMarca := True;
  BtnGerar.Click;
  FlgGeraUpdateMarca := False;
end;

procedure TFrmSmSaoFrancisco.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.CkbProdutoClick(Sender: TObject);
begin
  inherited;
  //btnInsertMarca.Enabled := True;
  btnUpdateMarca.Enabled := True;

  if CkbProduto.Checked = False then
  begin
    //btnInsertMarca.Enabled := False;
    btnUpdateMarca.Enabled := False;
  end;
end;

procedure TFrmSmSaoFrancisco.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmSaoFrancisco.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmSaoFrancisco.GeraInsertMarca;
begin
  with QryPrincipal2 do
  begin
    Close;
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('      CODIGO_MARCAS AS COD_MARCA,   ');
     SQL.Add('   	  DESCRICAO_MARCAS AS DES_MARCA,   ');
     SQL.Add('   	  ''MASTER'' AS USUARIO,   ');
     SQL.Add('   	  ''2020-11-16'' AS DTA_CADASTRO,   ');
     SQL.Add('   	  ''2020-11-16'' AS DTA_ALTERACAO,   ');
    ...
    begin
      try
        ...
        //Writeln(Arquivo, 'INSERT INTO TAB_MARCA (COD_MARCA, DES_MARCA, USUARIO,  )');
...
procedure TFrmSmSaoFrancisco.GerarCest;
var
   count : integer;
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GerarCliente;
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       CLIENTES.CARTEIRA AS COD_CLIENTE,   ');
     SQL.Add('       CLIENTES.NOMECLIENTE AS DES_CLIENTE,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(CLIENTES.CPFCLIENTE, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,   ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('       	   WHEN CLIENTES.CODIGOCONVENIO = 0 THEN ''ISENTO''   ');
     SQL.Add('   		     ELSE ''''   ');
     SQL.Add('       END AS NUM_INSC_EST,   ');
     SQL.Add('          ');
     SQL.Add('       COALESCE(CLIENTES.ENDERECOCLIENTE, '''') AS DES_ENDERECO,   ');
     SQL.Add('       COALESCE(CLIENTES.BAIRROCLIENTE, '''') AS DES_BAIRRO,   ');
     SQL.Add('       COALESCE(CLIENTES.CIDADECLIENTE, '''') AS DES_CIDADE,   ');
     SQL.Add('       COALESCE(CLIENTES.UF, '''') AS DES_SIGLA,   ');
     SQL.Add('       COALESCE(CLIENTES.CEPCLIENTE, '''') AS NUM_CEP,   ');
     ...
     SQL.Add('          ');
     SQL.Add('       COALESCE(CLIENTES.LIMITECHEQUE, 0) AS VAL_LIMITE_CRETID,   ');
     SQL.Add('       COALESCE(CLIENTES.LIMITECLIENTE, 0) AS VAL_LIMITE_CONV,   ');
     SQL.Add('       0 AS VAL_DEBITO,   ');
     SQL.Add('       0 AS VAL_RENDA,   ');
     SQL.Add('       COALESCE(CLIENTES.CODIGOCONVENIO, 0) AS COD_CONVENIO,   ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.SITUACAO = ''compra nao autorizada'' THEN 1   ');
     SQL.Add('           ELSE 0    ');
     SQL.Add('       END AS COD_STATUS_PDV,   ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('   		     WHEN CLIENTES.CODIGOCONVENIO = 0 THEN ''S''   ');
     SQL.Add('   		     ELSE ''N''   ');
     ...
     SQL.Add('       REPLACE(COALESCE(CLIENTES.EMAIL, ''''), '';'', '''') AS DES_EMAIL,   ');
     ...
     SQL.Add('       CASE WHEN CLIENTES.SITUACAO = ''compra nao autorizada'' THEN 1 ELSE 0 END AS COD_STATUS_PDV_CONV,   ');
     SQL.Add('       ''S'' AS FLG_ENVIA_CODIGO,   ');
     SQL.Add('       '''' AS DTA_NASC_CONJUGE,   ');
     SQL.Add('       0 AS COD_CLASSIF   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CONTROLE_CLIENTES.DBO.CC_CLIENTES AS CLIENTES   ');
...
procedure TFrmSmSaoFrancisco.GerarCodigoBarras;
var
...
procedure TFrmSmSaoFrancisco.GerarComposicao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmSaoFrancisco.GerarCondPagCli;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.CODIGOCONVENIO = 1 THEN 25   ');
     SQL.Add('           WHEN CLIENTES.CODIGOCONVENIO = 2 THEN 25   ');
     SQL.Add('           WHEN CLIENTES.CODIGOCONVENIO = 3 THEN 1   ');
     SQL.Add('           ELSE 30   ');
     SQL.Add('       END AS NUM_CONDICAO,   ');
     SQL.Add('      ');
     SQL.Add('       8 AS COD_CONDICAO,   ');
...
procedure TFrmSmSaoFrancisco.GerarCondPagForn;
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GerarDecomposicao;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT DISTINCT   ');
     SQL.Add('   	PRODUTOS.CODPROD_PRODUTOS AS COD_PRODUTO,   ');
     SQL.Add('   	DECOMP.CODRENDIMENTO AS COD_PRODUTO_DECOM,   ');
     SQL.Add('   	DECOMP.QTDRENDIMENTO AS QTD_DECOMP,   ');
     SQL.Add('   	PRODUTOS.UNIDADE_PRODUTOS AS DES_UNIDADE   ');
     SQL.Add('   FROM   ');
     SQL.Add('   	CE_MOVRENDIMENTO AS DECOMP   ');
     SQL.Add('   LEFT JOIN CE_PRODUTOS AS PRODUTOS ON PRODUTOS.CODBARRA_PRODUTOS = DECOMP.BARRARENDIMENTO   ');
    ...
    try
      ...
      Layout.FieldByName('COD_PRODUTO').AsString := GerarPLU(QryPrincipal2.FieldByName('COD_PRODUTO').AsString);
      Layout.FieldByName('COD_PRODUTO_DECOM').AsString := GerarPLU(QryPrincipal2.FieldByName('COD_PRODUTO_DECOM').AsString);
//
...
procedure TFrmSmSaoFrancisco.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal2 do
  begin
...
procedure TFrmSmSaoFrancisco.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmSaoFrancisco.GerarFinanceiroPagar(Aberto: String);
var
  NUM_DOCTO : string;
...
begin
  ...
  begin
    ...
    begin
       ...
       SQL.Add('                       ');
       SQL.Add('       CASE      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA = ''Cheque Terceiro'' THEN 9      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA = ''Conta Bancária'' THEN 10      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA = ''Cheque'' THEN 2      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA = ''Dinheiro'' THEN 1      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA IS NULL THEN 8      ');
       SQL.Add('           WHEN PAGAR.FORMABAIXA = '''' THEN 8      ');
//       SQL.Add('           WHEN PAGAR.FORMABAIXA = ''Conta Bancária'' THEN 12      ');
       SQL.Add('           ELSE 1      ');
       ...
       SQL.Add('   FROM      ');
       SQL.Add('       CONTAS.DBO.CONTAS_PAGAR AS PAGAR      ');
       ...
       SQL.Add('           FROM      ');
       SQL.Add('               CONTAS.DBO.CONTAS_PAGAR      ');
...
procedure TFrmSmSaoFrancisco.GerarFinanceiroReceber(Aberto: String);
var
   codParceiro : Integer;
   numDocto : String;
   count : integer;
begin
  ...
  begin
    ...
    begin
       ...
       SQL.Add('           WHEN CE_RECEBIMENTOSCAIXA.DESCRICAO = ''Cheque'' THEN 2      ');
       SQL.Add('           WHEN CE_RECEBIMENTOSCAIXA.DESCRICAO = ''Devolução'' THEN 13      ');
       ...
       SQL.Add('   AND CE_RECEBIMENTOSCAIXA.DESCRICAO = ''VALE''      ');
...
procedure TFrmSmSaoFrancisco.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmSaoFrancisco.GerarFornecedor;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(FORNECEDORES.OBSERVACOES, '''') AS DES_OBSERVACAO,   ');
...
procedure TFrmSmSaoFrancisco.GerarGrupo;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(PRODUTOS.CODIGOSETOR, 999) AS COD_SECAO,   ');
     SQL.Add('       COALESCE(PRODUTOS.CODGRU_PRODUTOS, 999) AS COD_GRUPO,   ');
     SQL.Add('       COALESCE(GRUPO.DESCRICAO_GRUPOS, ''A DEFINIR'') AS DES_GRUPO,   ');
     SQL.Add('       0 AS VAL_META   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CE_PRODUTOS AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CE_GRUPOS AS GRUPO ON GRUPO.CODIGO_GRUPOS = PRODUTOS.CODGRU_PRODUTOS   ');
...
procedure TFrmSmSaoFrancisco.GerarInfoNutricionais;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       NUTRI.CODIGO AS COD_INFO_NUTRICIONAL,   ');
     SQL.Add('       COALESCE(PRODUTOS.DESCRICAO_PRODUTOS, ''A DEFINIR'') AS DES_INFO_NUTRICIONAL,   ');
     SQL.Add('       COALESCE(NUTRI.QUANTIDADE, ''0'') AS PORCAO,   ');
     SQL.Add('       COALESCE(NUTRI.VALORCALORICO, ''0'') AS VALOR_CALORICO,   ');
     SQL.Add('       COALESCE(NUTRI.CARBOIDRATOS, ''0'') AS CARBOIDRATO,   ');
     SQL.Add('       COALESCE(NUTRI.PROTEINAS, ''0'') AS PROTEINA,   ');
     SQL.Add('       COALESCE(NUTRI.GORDURASTOTAIS, ''0'') AS GORDURA_TOTAL,   ');
     SQL.Add('       COALESCE(NUTRI.GORDURASSATURADAS, ''0'') AS GORDURA_SATURADA,   ');
     SQL.Add('       COALESCE(NUTRI.COLESTEROL, ''0'') AS COLESTEROL,   ');
     SQL.Add('       COALESCE(NUTRI.FIBRAALIMENTAR, ''0'') AS FIBRA_ALIMENTAR,   ');
     SQL.Add('       COALESCE(NUTRI.CALCIO, ''0'') AS CALCIO,   ');
     SQL.Add('       COALESCE(NUTRI.FERRO, ''0'') AS FERRO,   ');
     SQL.Add('       COALESCE(NUTRI.SODIO, ''0'') AS SODIO,   ');
     SQL.Add('       COALESCE(NUTRI.VDVALORCALORICO, ''0'') AS VD_VALOR_CALORICO,   ');
     SQL.Add('       COALESCE(NUTRI.VDCARBOIDRATOS, ''0'') AS VD_CARBOIDRATO,   ');
     SQL.Add('       COALESCE(NUTRI.VDPROTEINAS, ''0'') AS VD_PROTEINA,   ');
     SQL.Add('       COALESCE(NUTRI.GORDURASTOTAIS, ''0'') AS VD_GORDURA_TOTAL,   ');
     SQL.Add('       COALESCE(NUTRI.VDGORDURASSATURADAS, ''0'') AS VD_GORDURA_SATURADA,   ');
     SQL.Add('       COALESCE(NUTRI.VDCOLESTEROL, ''0'') AS VD_COLESTEROL,   ');
     SQL.Add('       COALESCE(NUTRI.VDFIBRAALIMENTAR, ''0'') AS VD_FIBRA_ALIMENTAR,   ');
     SQL.Add('       COALESCE(NUTRI.VDCALCIO, ''0'') AS VD_CALCIO,   ');
     SQL.Add('       COALESCE(NUTRI.VDFERRO, ''0'') AS VD_FERRO,   ');
     SQL.Add('       COALESCE(NUTRI.VDSODIO, ''0'') AS VD_SODIO,   ');
     SQL.Add('       0 AS GORDURA_TRANS,   ');
     SQL.Add('       0 AS VD_GORDURA_TRANS,   ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN NUTRI.UNIDADEPORCAO = ''Unidade'' THEN ''UN''   ');
     SQL.Add('           WHEN NUTRI.UNIDADEPORCAO = ''Mililitros'' THEN ''ML''   ');
     SQL.Add('           WHEN NUTRI.UNIDADEPORCAO = ''Gramas'' THEN ''G''   ');
     SQL.Add('           ELSE ''UN''   ');
     SQL.Add('       END AS UNIDADE_PORCAO,   ');
     SQL.Add('          ');
     SQL.Add('       ''A DEFINIR'' AS DES_PORCAO,   ');
     SQL.Add('       COALESCE(NUTRI.PARTEINTEIRAMEDIDACASEIRA, ''0'') AS PARTE_INTEIRA_MED_CASEIRA,   ');
     SQL.Add('       UPPER(NUTRI.MEDIDACASEIRAUTILIZADA) AS MED_CASEIRA_UTILIZADA   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CE_INFONUTRI AS NUTRI   ');
     SQL.Add('   LEFT JOIN CE_PRODUTOS AS PRODUTOS ON PRODUTOS.CODPROD_PRODUTOS = NUTRI.CODIGO ');
...
procedure TFrmSmSaoFrancisco.GerarNCM;
var
 count : Integer;
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GerarNCMUF;
var
 count : Integer;
begin
  inherited;
...
procedure TFrmSmSaoFrancisco.GerarNFClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
       ...
       SQL.Add('   SELECT   ');
       SQL.Add('   		 CASE   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 423 THEN 487036   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 424 THEN 487037   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 548 THEN 487038   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 575 THEN 487039   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 823 THEN 487040   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 898 THEN 487041   ');
       SQL.Add('   				 WHEN EMI_DEV.NUMERONOTA = 1621 THEN 487042   ');
       SQL.Add('   				 ELSE CLIENTES.CARTEIRA    ');
       ...
       SQL.Add('       '''' AS DES_OBSERVACAO,   ');
       SQL.Add('       COALESCE(EMI_DEV.CHAVEACESSO, '''') AS NUM_CHAVE_ACESSO   ');
       SQL.Add('   FROM   ');
       SQL.Add('       CE_NOTASFISCAISSAIDA AS EMI_DEV   ');
       SQL.Add('   LEFT JOIN CONTROLE_CLIENTES.DBO.CC_CLIENTES AS CLIENTES ON COALESCE(REPLACE(REPLACE(REPLACE(CLIENTES.CPFCLIENTE, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') = COALESCE(REPLACE(REPLACE(REPLACE(EMI_DEV.CPFOUCNPJ, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''')   ');
       SQL.Add('   WHERE EMI_DEV.CODIGOOPERACAO IN (5102, 5929, 1202)   ');
...
procedure TFrmSmSaoFrancisco.GerarNFFornec;
begin
  inherited;
  with QryPrincipal2 do
  begin
   ...
   SQL.Add('       ''N'' AS FLG_CANCELADO,   ');
   SQL.Add('       '''' AS DES_OBSERVACAO,   ');
   SQL.Add('       COALESCE(NF_ENTRADA.IDE_CHNFE, '''') AS NUM_CHAVE_ACESSO   ');
   SQL.Add('   FROM   ');
   ...
   SQL.Add('   WHERE NF_ENTRADA.ESTORNADA IS NULL  ');
...
procedure TFrmSmSaoFrancisco.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('   		 CASE   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 423 THEN 487036   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 424 THEN 487037   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 548 THEN 487038   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 575 THEN 487039   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 823 THEN 487040   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 898 THEN 487041   ');
     SQL.Add('   				 WHEN CAPA_DEVOLUCAO.NUMERONOTA = 1621 THEN 487042   ');
     SQL.Add('   				 ELSE CLIENTES.CARTEIRA    ');
     SQL.Add('   		 END AS COD_CLIENTE,    ');
     ...
     SQL.Add('   LEFT JOIN CONTROLE_CLIENTES.DBO.CC_CLIENTES AS CLIENTES ON COALESCE(REPLACE(REPLACE(REPLACE(CLIENTES.CPFCLIENTE, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') = COALESCE(REPLACE(REPLACE(REPLACE(CAPA_DEVOLUCAO.CPFOUCNPJ, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''')   ');
     SQL.Add('   WHERE CAPA_DEVOLUCAO.CODIGOOPERACAO IN (5102, 5929, 1202)   ');
     SQL.Add('   ORDER BY CAPA_DEVOLUCAO.NUMERONOTA, CAPA_DEVOLUCAO.CODIGOFORNECEDOR, CAPA_DEVOLUCAO.SERIE   ');
...
procedure TFrmSmSaoFrancisco.GerarNFitensFornec;
var
...
begin
  ...
  begin
   ...
   SQL.Add('           WHEN PRODUTOS.CODPROD_PRODUTOS = ''137241'' THEN ''137207''   ');
   SQL.Add('           WHEN PRODUTOS.CODPROD_PRODUTOS = ''138363'' THEN ''0138356''   ');
   SQL.Add('           WHEN PRODUTOS.CODPROD_PRODUTOS = ''111404'' THEN ''1000970''   ');
   SQL.Add('           ELSE PRODUTOS.CODPROD_PRODUTOS   ');
   SQL.Add('       END AS COD_PRODUTO,   ');
   SQL.Add('          ');
   SQL.Add('       CASE       ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''7.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 2   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''25.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 14   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''41.666'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''51.120'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 47   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''202'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''202'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''30.000'' THEN 31   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''41'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 23   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''500'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''101'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 8   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''202'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''25.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''52.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 18   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''900'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''20.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''20.000'' THEN 29   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''102'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''41.660'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''33.340'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''201'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 15   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 3   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 14   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''41.672'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''33.333'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''61.111'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 8   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''300'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''400'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''51'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 20   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG IS NULL AND NF_ITENS.ICMS_PALIQ_ORIG IS NULL AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = '''' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 3   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''25.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''25.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 5   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''7.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''7.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 2   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''00'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''25.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 14   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''20.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''20.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''20.000'' THEN 29   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''20.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''20.000'' THEN 29   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''10'' AND NF_ITENS.ICMS_PALIQ = ''20.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''20.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''20.000'' THEN 29   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''10'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''101'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''102'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''102'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''103'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.673'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 4   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.340'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.340'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 8   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.669'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.333'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.111'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 8   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.660'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.671'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.672'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 8   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 3   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''12.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.666'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 6   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''20'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 7   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''20'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''201'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''202'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''202'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''30.000'' THEN 31   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''202'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''300'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''40'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''400'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''400'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''400'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''41'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''41'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''41'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 23   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''500'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''500'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''51'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''51'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 20   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''51'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''60'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = '''' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''60'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''60'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 15   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 15   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''38.890'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 39   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.320'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.111'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''25.000'' AND NF_ITENS.ICMS_PREDBC = ''52.000'' AND NF_ITENS.ICMS_PALIQST = ''25.000'' THEN 18   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 12   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''12.000'' AND NF_ITENS.ICMS_PREDBC = ''41.670'' AND NF_ITENS.ICMS_PALIQST = ''12.000'' THEN 15   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''00'' AND NF_ITENS.ICMS_PALIQ = ''18.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.320'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 13   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''61.110'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 17   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''70'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''70'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''18.000'' AND NF_ITENS.ICMS_PREDBC = ''33.330'' AND NF_ITENS.ICMS_PALIQST = ''18.000'' THEN 16   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''90'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''90'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''90'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''20.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''22.000'' THEN 29   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''40'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''90'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 1   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''900'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''900'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 22   ');
   SQL.Add('           WHEN NF_ITENS.CST_ICMS = ''60'' AND NF_ITENS.ICMS_PALIQ = ''0.000'' AND NF_ITENS.CST_ICMS_ORIG = ''900'' AND NF_ITENS.ICMS_PALIQ_ORIG = ''0.000'' AND NF_ITENS.ICMS_PREDBC = ''0.000'' AND NF_ITENS.ICMS_PALIQST = ''0.000'' THEN 25     ');
   SQL.Add('           ELSE 22      ');
   SQL.Add('       END AS COD_TRIBUTACAO,    ');
   SQL.Add('      ');
   SQL.Add('       1 AS QTD_EMBALAGEM,   ');
   ...
   SQL.Add('   WHERE CAPA.ESTORNADA IS NULL  ');
...
procedure TFrmSmSaoFrancisco.GerarProdForn;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('               PRODUTOS.CODPROD_PRODUTOS AS COD_PRODUTO,      ');
     SQL.Add('               FORNECEDORES.CODIGO_FORNECEDORES AS COD_FORNECEDOR,      ');
     SQL.Add('               COALESCE(PROD_FORN.FORNECEDORCPROD, '''') AS DES_REFERENCIA,      ');
     SQL.Add('               COALESCE(REPLACE(REPLACE(REPLACE(FORNECEDORES.CNPJ_FORNECEDORES, ''.'', ''''), ''/'', ''''), ''-'', ''''), '''') AS NUM_CGC,      ');
     SQL.Add('               0 AS COD_DIVISAO,   ');
     SQL.Add('                  ');
     SQL.Add('               CASE    ');
     SQL.Add('   				        WHEN PROD_FORN.QTDEMBALAGEM = 1 THEN ''UN''    ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''BD'' THEN ''BD''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''BJ'' THEN ''BJ''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''CJ'' THEN ''CJ''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''CT'' THEN ''CT''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''CX'' THEN ''CX''    ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''DS'' THEN ''DS''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''DZ'' THEN ''DZ''    ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''EN'' THEN ''EN''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''EB'' THEN ''EB''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''FD'' THEN ''FD''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''FR'' THEN ''FR''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''GR'' THEN ''GR''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''KG'' THEN ''KG''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''L3'' THEN ''L3''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''PC'' THEN ''PC''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''PT'' THEN ''PT''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''UN'' THEN ''UN''   ');
     SQL.Add('   				        WHEN PROD_FORN.EMBALAGEM = ''DP'' THEN ''DP''   ');
     SQL.Add('   				        ELSE ''CX''    ');
     SQL.Add('   			       END AS DES_UNIDADE_COMPRA,      ');
     SQL.Add('               COALESCE(PROD_FORN.QTDEMBALAGEM, 1) AS QTD_EMBALAGEM_COMPRA,      ');
     ...
     SQL.Add('           LEFT JOIN PRODUTOFORNECEDOR AS PROD_FORN ON PROD_FORN.BARRASESTOQUE = PRODUTOS.CODBARRA_PRODUTOS   ');
     SQL.Add('   		     --AND PROD_FORN.CNPJ = FORNECEDORES.CNPJ_FORNECEDORES   ');
...
procedure TFrmSmSaoFrancisco.GerarProdLoja;
var
  count, count1 : Integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTOS.INUTILIZADO = 1 THEN ''S''   ');
     SQL.Add('           ELSE ''N''    ');
...
procedure TFrmSmSaoFrancisco.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT DISTINCT   ');
     SQL.Add('       PRODUTOS.CODFAMILIA AS COD_PRODUTO_SIMILAR,   ');
     SQL.Add('       SIMILAR.DESCRICAO AS DES_PRODUTO_SIMILAR,   ');
     SQL.Add('       0 AS VAL_META   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CE_PRODUTOS AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN FAMILIAS AS SIMILAR ON SIMILAR.CODIGO = PRODUTOS.CODFAMILIA   ');
     SQL.Add('   WHERE PRODUTOS.CODFAMILIA IS NOT NULL ');
