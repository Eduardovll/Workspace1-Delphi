...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.FISICA_JURIDICA = ''Física'' THEN ''N''   ');
     SQL.Add('           ELSE ''S''   ');
     ...
     SQL.Add('              ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.INATIVO = ''NÃO'' THEN ''N''    ');
     SQL.Add('           ELSE ''S''    ');
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN FORNECEDORES.INATIVO = ''NÃO'' THEN ''N''    ');
     SQL.Add('           ELSE ''S''    ');
     SQL.Add('       END AS INATIVO,   ');
     SQL.Add('      ');
     SQL.Add('       0 AS COD_CLASSIF,   ');
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTOS.INATIVO = ''Não'' THEN ''N''   ');
     SQL.Add('           ELSE ''S''    ');
