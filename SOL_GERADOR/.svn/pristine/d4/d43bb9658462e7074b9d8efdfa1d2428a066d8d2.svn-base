...
//    SQL.Add('      DATA_HORA_FIM <  SYSDATE ');
  ...
  begin
    ...
    SQL.Add('    ');
    SQL.Add('    CASE');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 7 THEN 2   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 25 THEN 5   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 4.5 THEN 38   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 12 THEN 3   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 11 THEN 35   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 8.8 THEN 24   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 5.5 THEN 38   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 5.6 THEN 38   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 4.7 THEN 53   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''000'' TENS_VENDA.ALIQUOTA = 18 THEN 4   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''020'' TENS_VENDA.ALIQUOTA = 18 THEN 8   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''020'' TENS_VENDA.ALIQUOTA = 7 THEN 6   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''020'' TENS_VENDA.ALIQUOTA = 12 THEN 6   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''040'' TENS_VENDA.ALIQUOTA = 0 THEN 1   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''041'' TENS_VENDA.ALIQUOTA = 0 THEN 23   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 25 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 22 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 30 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 18 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 20 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 0 THEN 25   ');
         SQL.Add('   WHEN ITENS_VENDA.CST = ''060'' TENS_VENDA.ALIQUOTA = 12 THEN 25   ');
...
begin
  ...
  begin
    ...
    SQL.Add('               WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 41   ');
    SQL.Add('               ELSE 1   ');
