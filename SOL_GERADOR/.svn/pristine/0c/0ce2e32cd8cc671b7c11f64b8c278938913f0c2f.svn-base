...
type
  TFrmJardimLago = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
procedure TFrmJardimLago.GerarProducao;
begin
  inherited;
...
procedure TFrmJardimLago.GerarProduto;
var
   cod_produto, codbarras, TIPO : string;
   TotalCount, count, COD_PROD, CODIGO : Integer;
...
//
//    SQL.Clear;
//    SQL.Add('UPDATE CED001 ');
//    SQL.Add('SET CODIGO_PRODUTO = :COD_PRODUTO  ');
//    SQL.Add('WHERE CODIGO = :COD_BARRA_PRINCIPAL ');
//    SQL.Add('AND COALESCE(TIPO, '''') <> ''B'' ');
//
//    try
//      ExecSQL;
//    except
//    end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       BARRAS.CBARRA AS COD_BARRA_PRINCIPAL,   ');
     SQL.Add('       PRODUTOS.NOME AS DES_REDUZIDA,   ');
     SQL.Add('       PRODUTOS.NOME AS DES_PRODUTO,   ');
     SQL.Add('       COALESCE(PRODUTOS.QTDE_EMBALAGEM, 1) AS QTD_EMBALAGEM_COMPRA,   ');
     SQL.Add('       COALESCE(PRODUTOS.UNIDADE, ''UN'') AS DES_UNIDADE_COMPRA,   ');
     SQL.Add('       1 AS QTD_EMBALAGEM_VENDA,   ');
     SQL.Add('       COALESCE(PRODUTOS.UNIDADE, ''UN'') AS DES_UNIDADE_VENDA,   ');
     SQL.Add('       0 AS TIPO_IPI,   ');
     SQL.Add('       COALESCE(PRODUTOS.PERC_IPI, 0) AS VAL_IPI,   ');
     SQL.Add('       COALESCE(PRODUTOS.GRUPO, 999) AS COD_SECAO,   ');
     SQL.Add('       999 AS COD_GRUPO,   ');
     SQL.Add('       999 AS COD_SUB_GRUPO,   ');
     SQL.Add('       0 AS COD_PRODUTO_SIMILAR,   ');
     SQL.Add('       CASE WHEN PRODUTOS.TIPO = ''B'' THEN ''S'' ELSE ''N'' END AS IPV,   ');
     SQL.Add('       CASE');
     SQL.Add('          WHEN PRODUTOS.VALIDADE_DIAS = '''' THEN 0 ');
     SQL.Add('          ELSE COALESCE(PRODUTOS.VALIDADE_DIAS, 0) ');
     SQL.Add('       END AS DIAS_VALIDADE, ');
     ...
     SQL.Add('          ');
     SQL.Add('       CASE WHEN PRODUTOS.TIPO = ''B'' THEN ''S'' ELSE ''N'' END AS FLG_ENVIA_BALANCA,   ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     ...
     SQL.Add('       CASE WHEN PRODUTOS.MOSTRA_ESTOQUE = ''N'' THEN 3 ELSE 0 END AS TIPO_ESPECIE,   ');
     SQL.Add('       0 AS COD_CLASSIF,   ');
     SQL.Add('       1 AS VAL_VDA_PESO_BRUTO,   ');
     SQL.Add('       COALESCE(PRODUTOS.PESO, 1) AS VAL_PESO_EMB,   ');
     ...
     SQL.Add('       0 AS NUM_NF,   ');
     SQL.Add('       COALESCE(PRODUTOS.DATAENTRADA, '''') AS DTA_ENTRADA,   ');
     SQL.Add('       0 AS COD_NAT_BEM,   ');
     SQL.Add('       0 AS VAL_ORIG_BEM,   ');
     SQL.Add('       PRODUTOS.NOME AS DES_PRODUTO_ANT,   ');
     SQL.Add('       PRODUTOS.TIPO AS TIPO');
     SQL.Add('   FROM   ');
     SQL.Add('       CED001 AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CED101 AS BARRAS ON BARRAS.CODIGO = PRODUTOS.CODIGO   ');

     //SQL.Add('   ORDER BY DES_PRODUTO   ');
...
//        begin
//          Inc(COD_PROD);
//          Params.ParamByName('COD_PRODUTO').Value := COD_PROD;
...
procedure TFrmJardimLago.GerarScriptAmarrarCEST;
begin
  with QryPrincipal do
  begin
    Close;
...
procedure TFrmJardimLago.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmJardimLago.GerarSecao;
var
   TotalCount : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(PRODUTOS.GRUPO, 999) AS COD_SECAO,   ');
     SQL.Add('       COALESCE(SECAO.NOME, ''A DEFINIR'') AS DES_SECAO,   ');
     SQL.Add('       0 AS VAL_META   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CED001 AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CED002 AS SECAO ON PRODUTOS.GRUPO = SECAO.CODIGO   ');
     SQL.Add('   ORDER BY PRODUTOS.NOME   ');
...
procedure TFrmJardimLago.GerarSubGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmJardimLago.GerarTransportadora;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarVenda;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmJardimLago.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmJardimLago.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmJardimLago.EdtCamBancoExit(Sender: TObject);
begin
  inherited;
  CriarFB(EdtCamBanco);
end;

procedure TFrmJardimLago.GerarCest;
var
   TotalCount : integer;
   count : integer;
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT DISTINCT   ');
     SQL.Add('       9999 AS COD_CEST,   ');
     SQL.Add('       ''1709201'' AS NUM_CEST,   ');
     SQL.Add('       ''A DEFINIR'' DES_CEST   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CED001 AS PRODUTOS   ');
...
procedure TFrmJardimLago.GerarCliente;
var
...
procedure TFrmJardimLago.GerarCodigoBarras;
var
 count : Integer;
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('           ELSE PRODUTOS.CODIGO_PRODUTO       ');
     SQL.Add('       END AS COD_PRODUTO,   ');
     SQL.Add('       BARRAS.CBARRA AS COD_EAN   ');
     SQL.Add('   FROM   ');
     SQL.Add('       CED001 AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CED101 AS BARRAS ON BARRAS.CODIGO = PRODUTOS.CODIGO   ');
     //SQL.Add('   ORDER BY NOME   ');
...
procedure TFrmJardimLago.GerarComposicao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmJardimLago.GerarCondPagForn;
var
...
procedure TFrmJardimLago.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmJardimLago.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmJardimLago.GerarFinanceiroPagar(Aberto: String);
var
   TotalCount : Integer;
   cgc: string;
begin
...
procedure TFrmJardimLago.GerarFinanceiroReceber(Aberto: String);
var
   TotalCount : Integer;
   cgc : string;
begin
...
procedure TFrmJardimLago.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarFornecedor;
var
...
procedure TFrmJardimLago.GerarGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmJardimLago.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmJardimLago.GerarNCM;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''0.000'' AND PRODUTOS.ICMS_SAIDA = ''0.000'' AND PRODUTOS.CT = ''160'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''0.000'' AND PRODUTOS.ICMS_SAIDA = ''0.000'' AND PRODUTOS.CT = ''201'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''0.000'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''051'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 20   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''0.000'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 13   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''1.25'' AND PRODUTOS.ICMS_SAIDA = ''1.25'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''1.62'' AND PRODUTOS.ICMS_SAIDA = ''1.62'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''1.86'' AND PRODUTOS.ICMS_SAIDA = ''1.86'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     ...
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''3.45'' AND PRODUTOS.ICMS_SAIDA = ''3.45'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''3.58'' AND PRODUTOS.ICMS_SAIDA = ''3.58'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 25   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''4.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 27   ');
     ...
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''010'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 3   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 3   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''41.67'' THEN 6   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''040'' AND PRODUTOS.PERC_REDUCAO = ''41.66'' THEN 6   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''040'' AND PRODUTOS.PERC_REDUCAO = ''41.67'' THEN 6   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 12   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''41.67'' THEN 15   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''12.00'' AND PRODUTOS.CT = ''070'' AND PRODUTOS.PERC_REDUCAO = ''41.67'' THEN 15   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 3   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''010'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 3   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''41.67'' THEN 6   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 15   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''12.00'' AND PRODUTOS.ICMS_SAIDA = ''30.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 12   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''0.000'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 4   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 4   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''33.33'' THEN 7   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''000'' AND PRODUTOS.PERC_REDUCAO = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''010'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 4   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 4   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''33.30'' THEN 7   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''33.33'' THEN 7   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''020'' AND PRODUTOS.PERC_REDUCAO = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''040'' AND PRODUTOS.PERC_REDUCAO = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 13   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''33.33'' THEN 16   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''060'' AND PRODUTOS.PERC_REDUCAO = ''61.11'' THEN 17   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''070'' AND PRODUTOS.PERC_REDUCAO = ''0.000'' THEN 13   ');
     SQL.Add('           WHEN PRODUTOS.ICMS_ENTRADA = ''18.00'' AND PRODUTOS.ICMS_SAIDA = ''18.00'' AND PRODUTOS.CT = ''070'' AND PRODUTOS.PERC_REDUCAO = ''33.33'' THEN 16   ');
     ...
     SQL.Add('          ');
     SQL.Add('       COALESCE(PRODUTOS.PERC_NCM, 0) AS PER_IVA,   ');
...
procedure TFrmJardimLago.GerarNCMUF;
var
 count, TotalCount : Integer;
begin
  inherited;
...
procedure TFrmJardimLago.GerarNFClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarNFFornec;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmJardimLago.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmJardimLago.GerarNFitensFornec;
var
...
procedure TFrmJardimLago.GerarProdForn;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmJardimLago.GerarProdLoja;
var
   TotalCount : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       END AS COD_PRODUTO,   ');
     SQL.Add('          ');
     SQL.Add('       PRODUTOS.VRCUSTO AS VAL_CUSTO_REP,   ');
     SQL.Add('       PRODUTOS.VRVENDA AS VAL_VENDA,   ');
     SQL.Add('       0 AS VAL_OFERTA,   ');
     SQL.Add('       COALESCE(ESTOQUE.QTDE, 1) AS QTD_EST_VDA,   ');
     ...
     SQL.Add('       END AS COD_TRIBUTACAO,   ');
     SQL.Add('      ');
     SQL.Add('       COALESCE(PRODUTOS.MARGEM_FIXA, 0) AS VAL_MARGEM,   ');
     ...
     SQL.Add('          ');
     SQL.Add('               CASE   ');
     SQL.Add('                   WHEN UPPER(PRODUTOS.ATIVO) = ''S'' THEN ''N''   ');
     SQL.Add('                   ELSE ''S''   ');
     ...
     SQL.Add('       COALESCE(PRODUTOS.QTMIN, 0) AS QTD_EST_MINIMO,   ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       CED001 AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN CED101 AS ESTOQUE ON ESTOQUE.CODIGO = PRODUTOS.CODIGO');
...
procedure TFrmJardimLago.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal do
  begin
