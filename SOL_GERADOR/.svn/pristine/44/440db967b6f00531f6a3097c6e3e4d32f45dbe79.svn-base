...
type
  TFrmSmBonfim = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
procedure TFrmSmBonfim.GerarProducao;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarProduto;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('        CASE   ');
     SQL.Add('           WHEN PRODUTOS.COD_BARRA IS NULL THEN PRODUTOS.CODIGO   ');
     SQL.Add('           WHEN PRODUTOS.COD_BARRA = '''' THEN PRODUTOS.CODIGO   ');
     SQL.Add('           WHEN PRODUTOS.COD_BARRA = ''SEM GTIN'' THEN PRODUTOS.CODIGO   ');
     SQL.Add('           WHEN PRODUTOS.COD_BARRA LIKE ''%G%'' THEN RIGHT(PRODUTOS.COD_BARRA, 13)   ');
     SQL.Add('           WHEN PRODUTOS.COD_BARRA LIKE ''%C%'' THEN RIGHT(PRODUTOS.COD_BARRA, 13)   ');
...
//     SQL.Add('             WHEN PRODUTOS.BALANCA = ''S'' OR PRODUTOS.UNIDADE = ''KG'' THEN ''KG''   ');
     ...
     SQL.Add('        PRODUTOS.COD_GR AS COD_SECAO,   ');
     SQL.Add('        999 AS COD_GRUPO,   ');
     SQL.Add('        999 AS COD_SUB_GRUPO,   ');
     SQL.Add('        0 AS COD_PRODUTO_SIMILAR,   ');
     SQL.Add('           ');
     SQL.Add('        CASE   ');
     SQL.Add('             WHEN PRODUTOS.UNIDADE = ''KG'' THEN ''S''   ');
     SQL.Add('             ELSE ''N''   ');
     SQL.Add('        END AS IPV,   ');
     SQL.Add('           ');
     SQL.Add('        COALESCE(PRODUTOS.BALANCA_VALIDADE, 0) AS DIAS_VALIDADE,   ');
     SQL.Add('        0 AS TIPO_PRODUTO,   ');
     SQL.Add('        CASE   ');
     SQL.Add('             WHEN PRODUTOS.PIS = ''01'' AND PRODUTOS.COFINS = ''01'' THEN ''N''   ');
     SQL.Add('             WHEN PRODUTOS.PIS = ''99'' AND PRODUTOS.COFINS = ''99'' THEN ''S''   ');
     SQL.Add('             ELSE ''N''    ');
     SQL.Add('        END AS FLG_NAO_PIS_COFINS,   ');
     SQL.Add('        CASE   ');
     SQL.Add('             WHEN PRODUTOS.BALANCA = ''S'' OR PRODUTOS.UNIDADE = ''KG'' THEN ''S''   ');
     SQL.Add('             WHEN PRODUTOS.UNIDADE = ''KG'' THEN ''S''   ');
     SQL.Add('             ELSE ''N''   ');
     SQL.Add('        END AS FLG_ENVIA_BALANCA,   ');
     SQL.Add('        CASE   ');
     SQL.Add('             WHEN PRODUTOS.PIS = ''01'' AND PRODUTOS.COFINS = ''01'' THEN -1   ');
     SQL.Add('             WHEN PRODUTOS.PIS = ''99'' AND PRODUTOS.COFINS = ''99'' THEN 0   ');
     SQL.Add('             ELSE -1    ');
...
procedure TFrmSmBonfim.GerarScriptAmarrarCEST;
begin
  with QryPrincipal do
  begin
    Close;
...
procedure TFrmSmBonfim.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmSmBonfim.GerarSecao;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarSubGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarTransportadora;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
  begin
    ...
    SQL.Clear;
      ...
      //INICIO VALOR DE VENDA GELADO

     SQL.Add('   SELECT   ');
//   SEM LETRA
//     SQL.Add('       CODIGO AS COD_PRODUTO,   ');
//     SQL.Add('       COD_BARRA AS VAL_VENDA_2   ');
//   COM LETRA
     SQL.Add('       COD_BARRA AS COD_PRODUTO,   ');
     SQL.Add('       VENDA AS VAL_VENDA_2   ');

     SQL.Add('   FROM TB_PRO   ');
     SQL.Add('   WHERE COD_BARRA IN (   ');

//   SEM LETRA

//     SQL.Add('           ''7894900557534'',      ');
//     SQL.Add('           ''7896984202003'',      ');
//     SQL.Add('           ''7894900660302'',      ');
//     SQL.Add('           ''7894900660265'',      ');
//     SQL.Add('           ''7894900558500'',      ');
//     SQL.Add('           ''7891098040749'',      ');
//     SQL.Add('           ''7891098040893'',      ');
//     SQL.Add('           ''7894900558524'',      ');
//     SQL.Add('           ''7891149108428'',      ');
//     SQL.Add('           ''7894900310016'',      ');
//     SQL.Add('           ''7894900014211'',      ');
//     SQL.Add('           ''7894900010398'',      ');
//     SQL.Add('           ''7894900660333'',      ');
//     SQL.Add('           ''7894900660319'',      ');
//     SQL.Add('           ''7894900558517'',      ');
//     SQL.Add('           ''7894900558005'',      ');
//     SQL.Add('           ''7894900558012'',      ');
//     SQL.Add('           ''7894900558029'',      ');
//     SQL.Add('           ''7891991011723'',      ');
//     SQL.Add('           ''7891149103270'',      ');
//     SQL.Add('           ''7898917681022'',      ');
//     SQL.Add('           ''7898917681084'',      ');
//     SQL.Add('           ''7896984215027'',      ');
//     SQL.Add('           ''7898956624059'',      ');
//     SQL.Add('           ''7894900093001'',      ');
//     SQL.Add('           ''7898945810050'',      ');
//     SQL.Add('           ''7894900093056'',      ');
//     SQL.Add('           ''7891991002561'',      ');
//     SQL.Add('           ''7896288202532'',      ');
//     SQL.Add('           ''7896045504831'',      ');
//     SQL.Add('           ''7896045523412'',      ');
//     SQL.Add('           ''7898956624684'',      ');
//     SQL.Add('           ''7891149108718'',      ');
//     SQL.Add('           ''7898956624073'',      ');
//     SQL.Add('           ''7898917681176'',      ');
//     SQL.Add('           ''7891098000637'',      ');
//     SQL.Add('           ''7891149105564'',      ');
//     SQL.Add('           ''7896288202525'',      ');
//     SQL.Add('           ''7894900704211'',      ');
//     SQL.Add('           ''7898917681060'',      ');
//     SQL.Add('           ''7898917681398'',      ');
//     SQL.Add('           ''7898917681411'',      ');
//     SQL.Add('           ''7898917308233'',      ');
//     SQL.Add('           ''7898917308240'',      ');
//     SQL.Add('           ''7898917308257'',      ');
//     SQL.Add('           ''7891991294942'',      ');
//     SQL.Add('           ''7898341430012'',      ');
//     SQL.Add('           ''7898341430036'',      ');
//     SQL.Add('           ''7898341430074'',      ');
//     SQL.Add('           ''7898341430098'',      ');
//     SQL.Add('           ''7898341430111'',      ');
//     SQL.Add('           ''7898164662669'',      ');
//     SQL.Add('           ''7898121400068'',      ');
//     SQL.Add('           ''7898121400365'',      ');
//     SQL.Add('           ''7897395020101'',      ');
//     SQL.Add('           ''7897395020217'',      ');
//     SQL.Add('           ''7897395030315'',      ');
//     SQL.Add('           ''7896984205103'',      ');
//     SQL.Add('           ''7896579420003'',      ');
//     SQL.Add('           ''7896288200101'',      ');
//     SQL.Add('           ''7898956624639'',      ');
//     SQL.Add('           ''7896288201016'',      ');
//     SQL.Add('           ''7898956624042'',      ');
//     SQL.Add('           ''7898956624066'',      ');
//     SQL.Add('           ''7898956624417'',      ');
//     SQL.Add('           ''7896065880069'',      ');
//     SQL.Add('           ''7896065880106'',      ');
//     SQL.Add('           ''7896065870497'',      ');
//     SQL.Add('           ''7896062800015'',      ');
//     SQL.Add('           ''7896025922075'',      ');
//     SQL.Add('           ''7896025935402'',      ');
//     SQL.Add('           ''7896025901230'',      ');
//     SQL.Add('           ''7896025983021'',      ');
//     SQL.Add('           ''7894900910018'',      ');
//     SQL.Add('           ''7894900911510'',      ');
//     SQL.Add('           ''7894900531015'',      ');
//     SQL.Add('           ''7894900700015'',      ');
//     SQL.Add('           ''7894900701609'',      ');
//     SQL.Add('           ''7894900500004'',      ');
//     SQL.Add('           ''7894900501001'',      ');
//     SQL.Add('           ''7894900502008'',      ');
//     SQL.Add('           ''7894900503005'',      ');
//     SQL.Add('           ''7894900504002'',      ');
//     SQL.Add('           ''7894900530001'',      ');
//     SQL.Add('           ''7894900530032'',      ');
//     SQL.Add('           ''7894900531008'',      ');
//     SQL.Add('           ''7894900300017'',      ');
//     SQL.Add('           ''7894900180503'',      ');
//     SQL.Add('           ''7894900180541'',      ');
//     SQL.Add('           ''7894900681000'',      ');
//     SQL.Add('           ''7894900061604'',      ');
//     SQL.Add('           ''7894900034219'',      ');
//     SQL.Add('           ''7894900113563'',      ');
//     SQL.Add('           ''7894900011609'',      ');
//     SQL.Add('           ''7894900011753'',      ');
//     SQL.Add('           ''7894900030013'',      ');
//     SQL.Add('           ''7894900031515'',      ');
//     SQL.Add('           ''7894900031607'',      ');
//     SQL.Add('           ''7894900050011'',      ');
//     SQL.Add('           ''7894900051513'',      ');
//     SQL.Add('           ''7894900053630'',      ');
//     SQL.Add('           ''7894900681017'',      ');
//     SQL.Add('           ''7894900010015'',      ');
//     SQL.Add('           ''7894900011517'',      ');
//     SQL.Add('           ''7894321722016'',      ');
//     SQL.Add('           ''7892840812423'',      ');
//     SQL.Add('           ''7892840800000'',      ');
//     SQL.Add('           ''7892840800406'',      ');
//     SQL.Add('           ''7891991009164'',      ');
//     SQL.Add('           ''7891991010481'',      ');
//     SQL.Add('           ''7891991014762'',      ');
//     SQL.Add('           ''7891991000840'',      ');
//     SQL.Add('           ''7891991001342'',      ');
//     SQL.Add('           ''7891991001359'',      ');
//     SQL.Add('           ''7891991001373'',      ');
//     SQL.Add('           ''7891991002646'',      ');
//     SQL.Add('           ''7891991002684'',      ');
//     SQL.Add('           ''7891991000727'',      ');
//     SQL.Add('           ''7891991000826'',      ');
//     SQL.Add('           ''7891991000833'',      ');
//     SQL.Add('           ''7891149440603'',      ');
//     SQL.Add('           ''7891149440801'',      ');
//     SQL.Add('           ''7891991015462'',      ');
//     SQL.Add('           ''7891149102785'',      ');
//     SQL.Add('           ''7891149102808'',      ');
//     SQL.Add('           ''7891149106639'',      ');
//     SQL.Add('           ''7891149103102'',      ');
//     SQL.Add('           ''7891149104932'',      ');
//     SQL.Add('           ''7891149105588'',      ');
//     SQL.Add('           ''7891149200504'',      ');
//     SQL.Add('           ''7891149201006'',      ');
//     SQL.Add('           ''7891149010301'',      ');
//     SQL.Add('           ''7891149010509'',      ');
//     SQL.Add('           ''7891149011001'',      ');
//     SQL.Add('           ''7891042005213'',      ');
//     SQL.Add('           ''7898231840082'',      ');
//     SQL.Add('           ''7898231840099'',      ');
//     SQL.Add('           ''7898231840075''      ');


//    COM LETRA

     SQL.Add('   ''G7894900557534'',   ');
     SQL.Add('   ''G7896984202003'',   ');
     SQL.Add('   ''G7894900660302'',   ');
     SQL.Add('   ''G7894900660265'',   ');
     SQL.Add('   ''G7894900558500'',   ');
     SQL.Add('   ''G7891098040749'',   ');
     SQL.Add('   ''G7891098040893'',   ');
     SQL.Add('   ''G7894900558524'',   ');
     SQL.Add('   ''G7891149108428'',   ');
     SQL.Add('   ''G7894900310016'',   ');
     SQL.Add('   ''G7894900014211'',   ');
     SQL.Add('   ''G7894900010398'',   ');
     SQL.Add('   ''G7894900660333'',   ');
     SQL.Add('   ''G7894900660319'',   ');
     SQL.Add('   ''G7894900558517'',   ');
     SQL.Add('   ''G7894900558005'',   ');
     SQL.Add('   ''G7894900558012'',   ');
     SQL.Add('   ''G7894900558029'',   ');
     SQL.Add('   ''G7891991011723'',   ');
     SQL.Add('   ''G7891149103270'',   ');
     SQL.Add('   ''G7898917681022'',   ');
     SQL.Add('   ''G7898917681084'',   ');
     SQL.Add('   ''G7896984215027'',   ');
     SQL.Add('   ''G7898956624059'',   ');
     SQL.Add('   ''G7894900093001'',   ');
     SQL.Add('   ''G7898945810050'',   ');
     SQL.Add('   ''G7894900093056'',   ');
     SQL.Add('   ''G7891991002561'',   ');
     SQL.Add('   ''G7896288202532'',   ');
     SQL.Add('   ''G7896045504831'',   ');
     SQL.Add('   ''G7896045523412'',   ');
     SQL.Add('   ''G7898956624684'',   ');
     SQL.Add('   ''G7891149108718'',   ');
     SQL.Add('   ''G7898956624073'',   ');
     SQL.Add('   ''G7898917681176'',   ');
     SQL.Add('   ''G7891098000637'',   ');
     SQL.Add('   ''G7891149105564'',   ');
     SQL.Add('   ''G7896288202525'',   ');
     SQL.Add('   ''C7894900704211'',   ');
     SQL.Add('   ''G7898917681060'',   ');
     SQL.Add('   ''G7898917681398'',   ');
     SQL.Add('   ''G7898917681411'',   ');
     SQL.Add('   ''G7898917308233'',   ');
     SQL.Add('   ''G7898917308240'',   ');
     SQL.Add('   ''G7898917308257'',   ');
     SQL.Add('   ''G7891991294942'',   ');
     SQL.Add('   ''G7898341430012'',   ');
     SQL.Add('   ''G7898341430036'',   ');
     SQL.Add('   ''G7898341430074'',   ');
     SQL.Add('   ''G7898341430098'',   ');
     SQL.Add('   ''G7898341430111'',   ');
     SQL.Add('   ''G7898164662669'',   ');
     SQL.Add('   ''G7898121400068'',   ');
     SQL.Add('   ''G7898121400365'',   ');
     SQL.Add('   ''G7897395020101'',   ');
     SQL.Add('   ''G7897395020217'',   ');
     SQL.Add('   ''G7897395030315'',   ');
     SQL.Add('   ''G7896984205103'',   ');
     SQL.Add('   ''G7896579420003'',   ');
     SQL.Add('   ''G7896288200101'',   ');
     SQL.Add('   ''G7898956624639'',   ');
     SQL.Add('   ''G7896288201016'',   ');
     SQL.Add('   ''G7898956624042'',   ');
     SQL.Add('   ''G7898956624066'',   ');
     SQL.Add('   ''G7898956624417'',   ');
     SQL.Add('   ''G7896065880069'',   ');
     SQL.Add('   ''G7896065880106'',   ');
     SQL.Add('   ''G7896065870497'',   ');
     SQL.Add('   ''G7896062800015'',   ');
     SQL.Add('   ''G7896025922075'',   ');
     SQL.Add('   ''G7896025935402'',   ');
     SQL.Add('   ''G7896025901230'',   ');
     SQL.Add('   ''G7896025983021'',   ');
     SQL.Add('   ''G7894900910018'',   ');
     SQL.Add('   ''G7894900911510'',   ');
     SQL.Add('   ''G7894900531015'',   ');
     SQL.Add('   ''G7894900700015'',   ');
     SQL.Add('   ''G7894900701609'',   ');
     SQL.Add('   ''G7894900500004'',   ');
     SQL.Add('   ''G7894900501001'',   ');
     SQL.Add('   ''G7894900502008'',   ');
     SQL.Add('   ''G7894900503005'',   ');
     SQL.Add('   ''G7894900504002'',   ');
     SQL.Add('   ''G7894900530001'',   ');
     SQL.Add('   ''G7894900530032'',   ');
     SQL.Add('   ''G7894900531008'',   ');
     SQL.Add('   ''G7894900300017'',   ');
     SQL.Add('   ''G7894900180503'',   ');
     SQL.Add('   ''G7894900180541'',   ');
     SQL.Add('   ''G7894900681000'',   ');
     SQL.Add('   ''G7894900061604'',   ');
     SQL.Add('   ''C7894900034219'',   ');
     SQL.Add('   ''G7894900113563'',   ');
     SQL.Add('   ''G7894900011609'',   ');
     SQL.Add('   ''G7894900011753'',   ');
     SQL.Add('   ''G7894900030013'',   ');
     SQL.Add('   ''G7894900031515'',   ');
     SQL.Add('   ''G7894900031607'',   ');
     SQL.Add('   ''G7894900050011'',   ');
     SQL.Add('   ''G7894900051513'',   ');
     SQL.Add('   ''G7894900053630'',   ');
     SQL.Add('   ''G7894900681017'',   ');
     SQL.Add('   ''G7894900010015'',   ');
     SQL.Add('   ''G7894900011517'',   ');
     SQL.Add('   ''G7894321722016'',   ');
     SQL.Add('   ''G7892840812423'',   ');
     SQL.Add('   ''G7892840800000'',   ');
     SQL.Add('   ''G7892840800406'',   ');
     SQL.Add('   ''G7891991009164'',   ');
     SQL.Add('   ''G7891991010481'',   ');
     SQL.Add('   ''G7891991014762'',   ');
     SQL.Add('   ''G7891991000840'',   ');
     SQL.Add('   ''G7891991001342'',   ');
     SQL.Add('   ''G7891991001359'',   ');
     SQL.Add('   ''G7891991001373'',   ');
     SQL.Add('   ''G7891991002646'',   ');
     SQL.Add('   ''G7891991002684'',   ');
     SQL.Add('   ''G7891991000727'',   ');
     SQL.Add('   ''G7891991000826'',   ');
     SQL.Add('   ''G7891991000833'',   ');
     SQL.Add('   ''G7891149440603'',   ');
     SQL.Add('   ''G7891149440801'',   ');
     SQL.Add('   ''G7891991015462'',   ');
     SQL.Add('   ''G7891149102785'',   ');
     SQL.Add('   ''G7891149102808'',   ');
     SQL.Add('   ''G7891149106639'',   ');
     SQL.Add('   ''G7891149103102'',   ');
     SQL.Add('   ''G7891149104932'',   ');
     SQL.Add('   ''G7891149105588'',   ');
     SQL.Add('   ''G7891149200504'',   ');
     SQL.Add('   ''G7891149201006'',   ');
     SQL.Add('   ''G7891149010301'',   ');
     SQL.Add('   ''G7891149010509'',   ');
     SQL.Add('   ''G7891149011001'',   ');
     SQL.Add('   ''G7891042005213'',   ');
     SQL.Add('   ''G7898231840082'',   ');
     SQL.Add('   ''G7898231840099'',   ');
     SQL.Add('   ''G7898231840075''   ');
//

     SQL.Add('   )   ');

      // FIM VALOR DE VENDA GELADO


     // VALOR DE VENDA DEMAIS PRODUTOS

//      SQL.Add('   SELECT   ');
//      SQL.Add('       PRODUTOS.CODIGO AS COD_PRODUTO,   ');
//      SQL.Add('       PRODUTOS.VENDA AS VAL_VENDA   ');
//      SQL.Add('   FROM   ');
//      SQL.Add('       TB_PRO AS PRODUTOS   ');
//      SQL.Add('   WHERE PRODUTOS.VENDA > 0  ');
...
//        Writeln(Arquivo, 'UPDATE TAB_PRODUTO_LOJA SET COD_BARRA_AUX = ''G'+QryPrincipal.FieldByName('VAL_VENDA_2').AsString+''' WHERE COD_PRODUTO = '+COD_PRODUTO+' ; ');
         ...
         //com letra
        Writeln(Arquivo, 'UPDATE TAB_PRODUTO_LOJA SET VAL_VENDA_2 = '''+QryPrincipal.FieldByName('VAL_VENDA_2').AsString+''' WHERE COD_BARRA_AUX = '''+QryPrincipal.FieldByName('COD_PRODUTO').AsString+''' ; ');


          // DEMAIS PRODUTOS NÃO GELADOS
...
procedure TFrmSmBonfim.GerarVenda;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmBonfim.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmBonfim.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmBonfim.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmBonfim.BtnGerarClick(Sender: TObject);
begin
//  inherited;
...
procedure TFrmSmBonfim.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmBonfim.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmBonfim.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmBonfim.EdtCamBancoExit(Sender: TObject);
begin
  inherited;
  CriarFB(EdtCamBanco);
end;

procedure TFrmSmBonfim.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
//    SQL.Add('           ELSE PRODUTOS.COD_MATERIAL   ');
    SQL.Add('       PRODUTOS.CODIGO AS COD_PRODUTO,   ');
    SQL.Add('       PRODUTOS.CUSTO AS VAL_CUSTO_REP   ');
    SQL.Add('   FROM   ');
    SQL.Add('       TB_PRO AS PRODUTOS   ');
    SQL.Add('   WHERE PRODUTOS.VENDA > 0  ');
...
procedure TFrmSmBonfim.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
//    SQL.Add('           ELSE PRODUTOS.COD_MATERIAL   ');
    SQL.Add('       PRODUTOS.CODIGO AS COD_PRODUTO,   ');
    SQL.Add('       PRODUTOS.QTD AS QTD_EST_ATUAL   ');
    SQL.Add('   FROM   ');
    SQL.Add('       TB_PRO AS PRODUTOS   ');
    SQL.Add('   WHERE PRODUTOS.VENDA > 0  ');
...
procedure TFrmSmBonfim.GerarCest;
var
   TotalCount : integer;
   count : integer;
begin
...
procedure TFrmSmBonfim.GerarCliente;
//var
...
procedure TFrmSmBonfim.GerarCodigoBarras;
var
...
procedure TFrmSmBonfim.GerarComposicao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarCondPagForn;
//var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   FROM   ');
     SQL.Add('        TB_FORNEC AS FORNECEDOR   ');
...
procedure TFrmSmBonfim.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmBonfim.GerarFinanceiroPagar(Aberto: String);
var
   TotalCount : Integer;
   cgc: string;
begin
...
procedure TFrmSmBonfim.GerarFinanceiroReceber(Aberto: String);
var
   TotalCount : Integer;
   cgc : string;
begin
...
procedure TFrmSmBonfim.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarFornecedor;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       CASE WHEN FORNECEDOR.FANTASIA = '''' THEN FORNECEDOR.RAZAOSOCIAL ELSE FORNECEDOR.FANTASIA END AS DES_FANTASIA,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(FORNECEDOR.CNPJ, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,   ');
     SQL.Add('       FORNECEDOR.IE AS NUM_INSC_EST,   ');
     ...
     SQL.Add('       COALESCE(FORNECEDOR.CONTATO, FORNECEDOR.RAZAOSOCIAL) AS DES_CONTATO,   ');
     ...
     SQL.Add('       ''N'' AS MICRO_EMPRESA,   ');
     SQL.Add('       FORNECEDOR.CODIGO AS COD_FORNECEDOR_ANT,   ');
     SQL.Add('       COALESCE(FORNECEDOR.NUMERO, ''S/N'') AS NUM_ENDERECO,   ');
     SQL.Add('       COALESCE(CAST(FORNECEDOR.OBS AS VARCHAR(500)), '''') AS DES_OBSERVACAO,   ');
...
procedure TFrmSmBonfim.GerarGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarNCM;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('                CASE   ');
     SQL.Add('                    WHEN PRODUTOS.COD_NCM = ''00000000'' AND PRODUTOS.CEST = '''' THEN ''99999999''   ');
     SQL.Add('                    WHEN PRODUTOS.COD_NCM = ''00000000'' AND PRODUTOS.CEST = ''0802200'' THEN ''99999998''   ');
     SQL.Add('                    ELSE PRODUTOS.COD_NCM   ');
     ...
     SQL.Add('           ');
     SQL.Add('        CASE   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 1 AND PRODUTOS.ALIQUOTA = ''0.00'' THEN 13   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 1 AND PRODUTOS.ALIQUOTA = ''8.00'' THEN 13   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 1 AND PRODUTOS.ALIQUOTA = ''20.00'' THEN 13   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 2 AND PRODUTOS.ALIQUOTA = ''0.00'' THEN 39   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 2 AND PRODUTOS.ALIQUOTA = ''8.00'' THEN 39   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 2 AND PRODUTOS.ALIQUOTA = ''20.00'' THEN 39   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 3 AND PRODUTOS.ALIQUOTA = ''0.00'' THEN 1   ');
     SQL.Add('            WHEN PRODUTOS.IMP_ID = 3 AND PRODUTOS.ALIQUOTA = ''8.00'' THEN 1   ');
     SQL.Add('            ELSE 1   ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('        TB_PRO AS PRODUTOS   ');
     SQL.Add('   LEFT JOIN TB_NFE_NCM AS NCM ON NCM.NCM = PRODUTOS.COD_NCM   ');
...
procedure TFrmSmBonfim.GerarNCMUF;
var
 count, TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarNFClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarNFFornec;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmBonfim.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmBonfim.GerarNFitensFornec;
var
...
procedure TFrmSmBonfim.GerarProdForn;
var
...
procedure TFrmSmBonfim.GerarProdLoja;
var
   TotalCount, NEW_CODPROD : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('        PRODUTOS.CUSTO AS VAL_CUSTO_REP,   ');
     SQL.Add('        PRODUTOS.VENDA AS VAL_VENDA,   ');
     SQL.Add('        PRODUTOS.PR_PR_VLR AS VAL_OFERTA,   ');
     SQL.Add('        PRODUTOS.QTD AS QTD_EST_VDA,   ');
     ...
     SQL.Add('            ELSE 1   ');
     SQL.Add('        END AS COD_TRIBUTACAO,   ');
     SQL.Add('        COALESCE(PRODUTOS.DCV, 0) AS VAL_MARGEM,   ');
     ...
     SQL.Add('           ');
     SQL.Add('        CASE   ');
     SQL.Add('             WHEN PRODUTOS.STATUS = ''2'' THEN ''S''   ');
     SQL.Add('             ELSE ''N''   ');
...
//     SQL.Add('        (SUBSTRING(PRODUTOS.PR_VISTA_VALIDADE FROM 6 FOR 2) || ''/'' ||      ');
//     SQL.Add('                   SUBSTRING(PRODUTOS.PR_VISTA_VALIDADE FROM 9 FOR 2) || ''/'' ||      ');
//     SQL.Add('                   SUBSTRING(PRODUTOS.PR_VISTA_VALIDADE FROM 1 FOR 4)      ');
     SQL.Add('        PRODUTOS.PR_VISTA_VALIDADE AS DTA_VALIDA_OFERTA,    ');
     SQL.Add('        PRODUTOS.MINIMO AS QTD_EST_MINIMO,   ');
...
procedure TFrmSmBonfim.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal do
  begin
