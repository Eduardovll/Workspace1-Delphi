...
uses
  ...
  Math, FireDAC.Phys.ODBCDef, FireDAC.Stan.Intf, FireDAC.Phys,
  FireDAC.Phys.ODBCBase, FireDAC.Phys.ODBC;

type
  TFrmAriusTrio = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
procedure TFrmAriusTrio.GerarProducao;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarProduto;
var
 cod_produto : string;
 count : integer;
 codigos : string;
...
procedure TFrmAriusTrio.GerarReceitas;
var
  texto : string;
begin
  inherited;
...
SQL.Add('SELECT');
SQL.Add('  PRODUTOS.ID AS COD_INFO_RECEITA,');
...
procedure TFrmAriusTrio.GerarScriptAmarrarCEST;
begin
...
procedure TFrmAriusTrio.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmAriusTrio.GerarSecao;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarSubGrupo;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarTransportadora;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarVenda;
var
    QryCusto : TADOQuery;
    custo : currency;
begin
...
procedure TFrmAriusTrio.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmAriusTrio.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmAriusTrio.BtnGerarClick(Sender: TObject);
begin
...
procedure TFrmAriusTrio.GerarCest;
var
   count : integer;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarCliente;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarCodigoBarras;
var
 count : Integer;
 cod_antigo : string;
begin
...
procedure TFrmAriusTrio.GerarComposicao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarCondPagForn;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmAriusTrio.GerarFinanceiroPagar(Aberto: String);
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Add('        WHEN 2 THEN 1');
    SQL.Add('        WHEN 3 THEN 7');
    SQL.Add('        WHEN 4 THEN 18');
    SQL.Add('        WHEN 5 THEN 19');
    SQL.Add('        WHEN 10 THEN 20');
    SQL.Add('        WHEN 12 THEN 21');
    SQL.Add('        WHEN 13 THEN 6');
    SQL.Add('        WHEN 14 THEN 22');
    SQL.Add('        WHEN 15 THEN 23');
    SQL.Add('        WHEN 16 THEN 24');
    SQL.Add('  ');
...
procedure TFrmAriusTrio.GerarFinanceiroReceber(Aberto: String);
var
   codParceiro : Integer;
   numDocto : String;
   count : integer;
begin
  ...
  begin
    ...
    SQL.Add('        WHEN 9 THEN 5');
    SQL.Add('        WHEN 10 THEN 11');
    SQL.Add('        WHEN 12 THEN 8');
    SQL.Add('        WHEN 13 THEN 12');
    SQL.Add('        WHEN 15 THEN 4');
    SQL.Add('        WHEN 16 THEN 13');
    SQL.Add('        WHEN 17 THEN 14        ');
    SQL.Add('    END AS COD_ENTIDADE,');
    SQL.Add('');
...
procedure TFrmAriusTrio.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarFornecedor;
var
...
procedure TFrmAriusTrio.GerarGrupo;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarNCM;
var
 count : Integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Add('');
    SQL.Add('    CASE');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 00 AND TRIB_SAIDA.ICMS_VENDA = 7 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 2');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 00 AND TRIB_SAIDA.ICMS_VENDA = 11 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 35');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 00 AND TRIB_SAIDA.ICMS_VENDA = 12 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 3');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 00 AND TRIB_SAIDA.ICMS_VENDA = 18 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 4');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 00 AND TRIB_SAIDA.ICMS_VENDA = 25 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 5');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 20 AND TRIB_SAIDA.ICMS_VENDA = 12 AND TRIB_SAIDA.REDUCAO_VENDA = 30 THEN 84');
    ...
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 40 AND TRIB_SAIDA.ICMS_VENDA = 2 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 1');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 41 AND TRIB_SAIDA.ICMS_VENDA = 0 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 23');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 0 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 25');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 12 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 12');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 12 AND TRIB_SAIDA.REDUCAO_VENDA = 41.67 THEN 15');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 18 AND TRIB_SAIDA.REDUCAO_VENDA = 0 THEN 13');
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 18 AND TRIB_SAIDA.REDUCAO_VENDA = 33.33 THEN 16');
    ...
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 60 AND TRIB_SAIDA.ICMS_VENDA = 25 AND TRIB_SAIDA.REDUCAO_VENDA = 52 THEN 18');
    ...
    SQL.Add('        WHEN SUBSTR(TRIB_SAIDA.ST_VENDA,2,2) = 70 AND TRIB_SAIDA.ICMS_VENDA = 18 AND TRIB_SAIDA.REDUCAO_VENDA = 33.33 THEN 81');
    ...
    SQL.Add('');
    SQL.Add('    CASE');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 39');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 1.25 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 39');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 1.36 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 40');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 1.44 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 41');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 1.86 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 43');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.33 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 44');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.56 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 45');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.58 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 46');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.73 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 50');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.84 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 52');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.87 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 52');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.9 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 53');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.94 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 54');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 2.97 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 55');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.06 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 56');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.07 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 56');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.12 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 56');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.14 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 56');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.16 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 57');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.38 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 60');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.41 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 61');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.53 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 62');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.55 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 63');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.59 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 65');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 3.68 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 68');
    ...
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 0 AND TRIBUTACAO_ENTRADA.ICMS = 11 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 35');
    ...
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 22');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 4 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 71');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 72');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 73');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 20 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 75');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 25 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 76');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 10 AND TRIBUTACAO_ENTRADA.ICMS = 30 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 77');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 20 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 33.33 THEN 22');
    ...
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 20 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 100 THEN 22');
    ...
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 50 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 21');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 51 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 20');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 51 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 1 THEN 22');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 51 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 100 THEN 22');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 25');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 1.25 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 39');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 2.33 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 44');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 3.38 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 69');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 3.68 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 69');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 60 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 13');
    ...
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 78');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 41.66 THEN 79');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 41.67 THEN 79');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 12 AND TRIBUTACAO_ENTRADA.REDUCAO = 61.11 THEN 85');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 33.32 THEN 81');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 33.33 THEN 81');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 61.11 THEN 82');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 18 AND TRIBUTACAO_ENTRADA.REDUCAO = 100 THEN 22');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 70 AND TRIBUTACAO_ENTRADA.ICMS = 25 AND TRIBUTACAO_ENTRADA.REDUCAO = 52 THEN 83');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 90 AND TRIBUTACAO_ENTRADA.ICMS = 0 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 22');
    SQL.Add('        WHEN TRIBUTACAO_ENTRADA.CST = 90 AND TRIBUTACAO_ENTRADA.ICMS = 3.48 AND TRIBUTACAO_ENTRADA.REDUCAO = 0 THEN 22');
...
procedure TFrmAriusTrio.GerarNCMUF;
var
 count : Integer;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarNFClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarNFFornec;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Add('');
    SQL.Add('    CASE CAPA.ID_COI_A');
    SQL.Add('        WHEN 42 THEN 1');
    SQL.Add('        WHEN 44 THEN 5');
    SQL.Add('        WHEN 43 THEN 2');
    SQL.Add('        WHEN 52 THEN 6');
...
procedure TFrmAriusTrio.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarNFitensFornec;
VAR
...
begin
  ...
  begin
    ...
    SQL.Add('');
    SQL.Add('    CASE');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 0 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 39');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 39');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.36 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 40');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.44 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 41');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.81 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 42');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.86 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 43');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.33 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 44');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.56 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 45');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.58 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 46');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.69 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 47');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.7 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 48');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.72 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 49');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.73 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 50');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.74 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 51');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.87 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 52');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.9 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 53');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.94 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 54');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.97 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 55');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.14 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 56');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.16 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 57');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 58');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.27 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 59');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.38 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 60');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.41 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 61');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.53 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 62');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.55 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 63');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.57 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 64');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.59 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 65');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.6 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 66');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.61 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 67');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.68 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 68');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.82 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 69');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.83 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 70');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 4 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 27');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 7 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 2');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 11 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 35');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 3');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 17 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 4');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 4');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 00 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 5');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 4 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 71');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 72');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 73');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.33 THEN 74');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 20 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 75');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 76');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 10 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 30 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 77');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 0 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.33 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 8.33 THEN 34');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 41.66 THEN 6');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 41.667 THEN 6');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 41.67 THEN 6');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.33 THEN 7');
    ...
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 61.11 THEN 8');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 20 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 100 THEN 22');
    ...
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 51 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 0 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 20');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 51 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 0 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 100 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 51 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 100 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 0 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 25');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 39');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 1.86 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 43');
    ...
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.68 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 69');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 13');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 41.67 THEN 15');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 13');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.33 THEN 16');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 61.11 THEN 17');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 60 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 14');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 78');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 41.67 THEN 79');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 100 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 80');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.32 THEN 81');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 33.33 THEN 81');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 61.11 THEN 82');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 18 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 100 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 70 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 25 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 52 THEN 83');
    ...
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 90 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 2.33 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 90 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 3.48 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 22');
    SQL.Add('        WHEN SUBSTR(ITEM.CST_ICMS,2,2) = 90 AND COALESCE(ITEM.ALIQ_ICMS, 0) = 12 AND COALESCE(ITEM.VALOR_REDUCAO_BASE_A, 0) = 0 THEN 22');
    SQL.Add('    END AS COD_TRIBUTACAO, --');
    SQL.Add('');
    SQL.Add('    ITEM.EMBALAGEM_A AS QTD_EMBALAGEM,');
    SQL.Add('    ITEM.QTD AS QTD_ENTRADA,');
...
procedure TFrmAriusTrio.GerarProdForn;
begin
  inherited;
...
procedure TFrmAriusTrio.GerarProdLoja;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmAriusTrio.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal2 do
  begin
