...
type
  TFrmSmPinkCosmGiga = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
var
  FrmSmPinkCosmGiga: TFrmSmPinkCosmGiga;
  ListNCM    : TStringList;
  TotalCont  : Integer;
  NumLinha : Integer;
  Arquivo: TextFile;
...
procedure TFrmSmPinkCosmGiga.GerarProducao;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarProduto;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       COALESCE(PRODUTOS.DESC_PRODUTO_FISCAL, PRODUTOS.DESC_PRODUTO) AS DES_REDUZIDA,      ');
     ...
     SQL.Add('       COALESCE(PRODUTOS.OBS, '''') AS DES_OBSERVACAO,   ');
     SQL.Add('       0 AS COD_INFO_NUTRICIONA,      ');
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     //SQL.Add('           WHEN PRODUTOS.PESO_BRUTO < 1 THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.PESO_BRUTO = 0 THEN 1   ');
     SQL.Add('           ELSE COALESCE(PRODUTOS.PESO_BRUTO, 1)   ');
     SQL.Add('       END AS VAL_VDA_PESO_BRUTO,   ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     //SL.Add('           WHEN PRODUTOS.PESO_LIQUIDO < 1 THEN 1   ');
     SQL.Add('           WHEN PRODUTOS.PESO_LIQUIDO = 0 THEN 1   ');
     SQL.Add('           ELSE COALESCE(PRODUTOS.PESO_LIQUIDO, 1)   ');
...
procedure TFrmSmPinkCosmGiga.GerarReceitas;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarScriptAmarrarCEST;
begin
  with QryPrincipal do
  begin
    Close;
...
procedure TFrmSmPinkCosmGiga.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmSmPinkCosmGiga.GerarSecao;
var
   TotalCount : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT DISTINCT   ');
     SQL.Add('       COALESCE(PRODUTOS.COD_GRUPO, 999) AS COD_SECAO,   ');
     SQL.Add('       COALESCE(GRUPOS_PRODUTO.DESC_GRUPO, ''A DEFINIR'') AS DES_SECAO,   ');
     SQL.Add('       0 AS VAL_META   ');
     SQL.Add('   FROM   ');
     SQL.Add('       GRUPOS_PRODUTO   ');
     SQL.Add('   LEFT JOIN PRODUTOS ON PRODUTOS.COD_GRUPO = GRUPOS_PRODUTO.COD_GRUPO   ');
    Open;
...
procedure TFrmSmPinkCosmGiga.GerarSubGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarTransportadora;
var
  TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmPinkCosmGiga.GerarVenda;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmPinkCosmGiga.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmPinkCosmGiga.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.BtnGerarClick(Sender: TObject);
begin
//  inherited;
...
procedure TFrmSmPinkCosmGiga.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.EdtCamBancoExit(Sender: TObject);
begin
  inherited;
  CriarFB(EdtCamBanco);
end;

procedure TFrmSmPinkCosmGiga.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmPinkCosmGiga.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmPinkCosmGiga.GerarCest;
var
   TotalCount : integer;
   count : integer;
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       0 AS COD_CEST,   ');
     SQL.Add('       COALESCE(CEST.COD_CEST, ''9999999'') AS NUM_CEST,   ');
     SQL.Add('       COALESCE(CEST.DESC_CEST, ''A DEFINIR'') AS DES_CEST    ');
     SQL.Add('   FROM   ');
     SQL.Add('       CEST   ');
...
procedure TFrmSmPinkCosmGiga.GerarCliente;
//var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT      ');
     SQL.Add('       CLIENTES.COD_CLIENTE AS COD_CLIENTE,      ');
     SQL.Add('       PESSOAS.RAZAO_SOCIAL AS DES_CLIENTE,      ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(PESSOAS.CNPJ_CPF, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,       ');
     SQL.Add('             ');
     SQL.Add('       CASE      ');
     SQL.Add('           WHEN PESSOAS.TIPO_CLASSIFICACAO = 0 AND PESSOAS.INSCR_ESTADUAL = '''' THEN ''ISENTO''   ');
     SQL.Add('           WHEN PESSOAS.TIPO_CLASSIFICACAO = 0 THEN COALESCE(REPLACE(REPLACE(REPLACE(PESSOAS.INSCR_ESTADUAL, ''-'', ''''), ''.'', ''''), ''/'', ''''), ''ISENTO'')   ');
     SQL.Add('           ELSE ''''   ');
     SQL.Add('       END AS NUM_INSC_EST,      ');
     SQL.Add('         ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PESSOAS_ENDERECOS.ENDERECO = '''' THEN ''A CONFIRMAR''   ');
     SQL.Add('           ELSE COALESCE(PESSOAS_ENDERECOS.ENDERECO, ''A CONFIRMAR'')   ');
     SQL.Add('       END AS DES_ENDERECO,   ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PESSOAS_ENDERECOS.BAIRRO = '''' THEN ''A CONFIRMAR''   ');
     SQL.Add('           ELSE COALESCE(PESSOAS_ENDERECOS.BAIRRO, ''A CONFIRMAR'')   ');
     SQL.Add('       END AS DES_BAIRRO,   ');
     SQL.Add('      ');
     SQL.Add('       MUNICIPIOS.NOME_MUNIC AS DES_CIDADE,      ');
     SQL.Add('       MUNICIPIOS.UF AS DES_SIGLA,      ');
     SQL.Add('       PESSOAS_ENDERECOS.CEP AS NUM_CEP,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.TELEFONE, '''') AS NUM_FONE,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.FAX, '''') AS NUM_FAX,      ');
     SQL.Add('       PESSOAS.RAZAO_SOCIAL AS DES_CONTATO,      ');
     SQL.Add('             ');
     SQL.Add('       CASE      ');
     ...
     SQL.Add('       COALESCE(CLIENTES.LIMITE_CREDITO, 0) AS VAL_LIMITE_CONV,   ');
     SQL.Add('       0 AS VAL_DEBITO,      ');
     SQL.Add('       0 AS VAL_RENDA,      ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.LIMITE_CREDITO > 0 THEN ''99999''   ');
     SQL.Add('           ELSE 0   ');
     ...
     SQL.Add('             ');
     SQL.Add('       CASE       ');
     SQL.Add('           WHEN PESSOAS.TIPO_CLASSIFICACAO = 0 THEN ''S''   ');
     SQL.Add('           ELSE ''N''   ');
     SQL.Add('       END AS FLG_EMPRESA,      ');
     SQL.Add('             ');
     SQL.Add('       ''N'' AS FLG_CONVENIO,      ');
     SQL.Add('       ''N'' AS MICRO_EMPRESA,      ');
     SQL.Add('       PESSOAS.DATA_CADASTRO AS DTA_CADASTRO,      ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PESSOAS_ENDERECOS.NUMERO = '''' THEN ''1234''   ');
     SQL.Add('           WHEN PESSOAS_ENDERECOS.NUMERO = ''0'' THEN ''1234''   ');
     SQL.Add('           ELSE COALESCE(PESSOAS_ENDERECOS.NUMERO, ''1234'')   ');
     SQL.Add('       END AS NUM_ENDERECO,   ');
     SQL.Add('      ');
     SQL.Add('       COALESCE(PESSOAS.RG, '''') AS NUM_RG,      ');
     SQL.Add('       0 AS FLG_EST_CIVIL,      ');
     SQL.Add('       COALESCE(PESSOAS_CONTATOS.CELULAR, '''') AS NUM_CELULAR,   ');
     SQL.Add('       CAST(PESSOAS.DATA_ALTERACAO AS DATE) AS DTA_ALTERACAO,      ');
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN CLIENTES.COD_VENDEDOR IS NOT NULL THEN COALESCE(PESSOAS.OBS_PESSOA, '''')   ');
     SQL.Add('           || ''**'' || VEND.C_VEND || ''|'' || VEND.N_VEND   ');
     SQL.Add('           ELSE COALESCE(PESSOAS.OBS_PESSOA, '''')   ');
     SQL.Add('       END AS DES_OBSERVACAO,   ');
     SQL.Add('      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.COMPLEMENTO, '''') AS DES_COMPLEMENTO,      ');
     SQL.Add('       COALESCE(PESSOAS.EMAIL, '''') AS DES_EMAIL,      ');
     SQL.Add('             ');
     SQL.Add('       CASE       ');
     SQL.Add('           WHEN PESSOAS.NOME_FANTASIA = '''' THEN PESSOAS.RAZAO_SOCIAL       ');
     SQL.Add('           ELSE COALESCE(PESSOAS.NOME_FANTASIA, '''')       ');
     ...
     SQL.Add('       CASE WHEN CLIENTES.FLAG_ATIVO = 1 THEN ''N'' ELSE ''S'' END AS INATIVO,      ');
     ...
     SQL.Add('   FROM      ');
     SQL.Add('       PESSOAS      ');
     SQL.Add('   LEFT JOIN CLIENTES ON CLIENTES.COD_CLIENTE = PESSOAS.COD_PESSOA      ');
     SQL.Add('   LEFT JOIN PESSOAS_ENDERECOS ON PESSOAS_ENDERECOS.COD_PESSOA = PESSOAS.COD_PESSOA      ');
     SQL.Add('   LEFT JOIN MUNICIPIOS ON MUNICIPIOS.COD_MUNIC = PESSOAS_ENDERECOS.COD_MUNIC   ');
     SQL.Add('   LEFT JOIN PESSOAS_CONTATOS ON PESSOAS_CONTATOS.COD_PESSOA = PESSOAS.COD_PESSOA   ');
     SQL.Add('   LEFT JOIN (   ');
     SQL.Add('       SELECT DISTINCT   ');
     SQL.Add('           CLIENTES.COD_CLIENTE,   ');
     SQL.Add('           CLIENTES.COD_VENDEDOR AS C_VEND,   ');
     SQL.Add('           PESSOAS.RAZAO_SOCIAL AS N_VEND   ');
     SQL.Add('       FROM   ');
     SQL.Add('           PESSOAS   ');
     SQL.Add('       LEFT JOIN CLIENTES ON CLIENTES.COD_VENDEDOR = PESSOAS.COD_PESSOA   ');
     SQL.Add('       WHERE CLIENTES.COD_VENDEDOR IS NOT NULL   ');
     SQL.Add('   ) AS VEND   ');
     SQL.Add('   ON VEND.COD_CLIENTE = PESSOAS.COD_PESSOA   ');
     SQL.Add('   WHERE PESSOAS.FLAG_CLIENTE = 1      ');
     SQL.Add('   AND CLIENTES.COD_CLIENTE IS NOT NULL   ');
...
procedure TFrmSmPinkCosmGiga.GerarCodigoBarras;
var
...
procedure TFrmSmPinkCosmGiga.GerarComposicao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarCondPagForn;
//var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       FORNECEDORES.COD_FORNECEDOR AS COD_FORNECEDOR,   ');
     SQL.Add('       30 AS NUM_CONDICAO,   ');
     SQL.Add('       2 AS COD_CONDICAO,   ');
     SQL.Add('       8 AS COD_ENTIDADE,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(PESSOAS.CNPJ_CPF, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC   ');
     SQL.Add('   FROM   ');
     SQL.Add('       PESSOAS   ');
     SQL.Add('   LEFT JOIN FORNECEDORES ON FORNECEDORES.COD_FORNECEDOR = PESSOAS.COD_PESSOA   ');
     SQL.Add('   WHERE PESSOAS.FLAG_FORNECEDOR = 1   ');
     SQL.Add('   AND FORNECEDORES.COD_FORNECEDOR IS NOT NULL   ');
...
procedure TFrmSmPinkCosmGiga.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmPinkCosmGiga.GerarFinanceiroPagar(Aberto: String);
var
...
procedure TFrmSmPinkCosmGiga.GerarFinanceiroReceber(Aberto: String);
var
   TotalCount : Integer;
   cgc : string;
begin
...
procedure TFrmSmPinkCosmGiga.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarFornecedor;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT      ');
     SQL.Add('       FORNECEDORES.COD_FORNECEDOR AS COD_FORNECEDOR,      ');
     SQL.Add('       PESSOAS.RAZAO_SOCIAL AS DES_FORNECEDOR,      ');
     SQL.Add('             ');
     SQL.Add('       CASE       ');
     SQL.Add('           WHEN PESSOAS.NOME_FANTASIA = '''' THEN PESSOAS.RAZAO_SOCIAL       ');
     SQL.Add('           ELSE COALESCE(PESSOAS.NOME_FANTASIA, '''')       ');
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PESSOAS.INSCR_ESTADUAL IS NULL OR PESSOAS.INSCR_ESTADUAL = '''' THEN ''ISENTO''   ');
     SQL.Add('           ELSE COALESCE(REPLACE(REPLACE(REPLACE(PESSOAS.INSCR_ESTADUAL, ''-'', ''''), ''.'', ''''), ''/'', ''''), ''ISENTO'')   ');
     SQL.Add('       END AS NUM_INSC_EST,   ');
     SQL.Add('      ');
     SQL.Add('       PESSOAS_ENDERECOS.ENDERECO AS DES_ENDERECO,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.BAIRRO, '''') AS DES_BAIRRO,      ');
     SQL.Add('       MUNICIPIOS.NOME_MUNIC AS DES_CIDADE,      ');
     SQL.Add('       MUNICIPIOS.UF AS DES_SIGLA,      ');
     SQL.Add('       PESSOAS_ENDERECOS.CEP AS NUM_CEP,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.TELEFONE, '''') AS NUM_FONE,      ');
     ...
     SQL.Add('       ''N'' AS MICRO_EMPRESA,      ');
     SQL.Add('       FORNECEDORES.COD_FORNECEDOR AS COD_FORNECEDOR_ANT,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.NUMERO, ''S/N'') AS NUM_ENDERECO,      ');
     SQL.Add('       COALESCE(PESSOAS.OBS_PESSOA, '''') AS DES_OBSERVACAO,      ');
     SQL.Add('       COALESCE(PESSOAS.EMAIL, '''') AS DES_EMAIL,   ');
     SQL.Add('       '''' AS DES_WEB_SITE,      ');
     ...
     SQL.Add('       CASE WHEN FORNECEDORES.FLAG_ATIVO = 1 THEN ''N'' ELSE ''S'' END AS INATIVO,      ');
     SQL.Add('       0 AS COD_CLASSIF,      ');
     SQL.Add('       PESSOAS.DATA_CADASTRO AS DTA_CADASTRO,      ');
     SQL.Add('       0 AS VAL_CREDITO,      ');
     SQL.Add('       0 AS VAL_DEBITO,      ');
     SQL.Add('       1 AS PED_MIN_VAL,      ');
     SQL.Add('       COALESCE(PESSOAS.EMAIL, '''') AS DES_EMAIL_VEND,   ');
     SQL.Add('       '''' AS SENHA_COTACAO,      ');
     SQL.Add('       -1 AS TIPO_PRODUTOR,      ');
     SQL.Add('       COALESCE(PESSOAS_ENDERECOS.CELULAR, '''') AS NUM_CELULAR      ');
     SQL.Add('   FROM      ');
     SQL.Add('       PESSOAS      ');
     SQL.Add('   LEFT JOIN FORNECEDORES ON FORNECEDORES.COD_FORNECEDOR = PESSOAS.COD_PESSOA      ');
     SQL.Add('   LEFT JOIN PESSOAS_ENDERECOS ON PESSOAS_ENDERECOS.COD_PESSOA = PESSOAS.COD_PESSOA      ');
...
procedure TFrmSmPinkCosmGiga.GerarGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarInfoNutricionais;
var
  TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarNCM;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(CLASS_FISCAIS.DESC_CLASS, ''A DEFINIR'') AS DES_NCM,   ');
     SQL.Add('          ');
     SQL.Add('       CASE          ');
     SQL.Add('           WHEN CLASS_FISCAIS.COD_CLASS = '''' THEN ''99999999''         ');
     SQL.Add('           WHEN CLASS_FISCAIS.COD_CLASS = ''00000000'' THEN ''99999999''          ');
     SQL.Add('           WHEN CLASS_FISCAIS.COD_CLASS = ''0'' THEN ''99999999''          ');
     SQL.Add('           ELSE COALESCE(CLASS_FISCAIS.COD_CLASS, ''99999999'')           ');
     SQL.Add('       END AS NUM_NCM,    ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTOS.COD_IMPOSTO = 1 THEN ''S''   ');
     ...
     SQL.Add('       END AS TIPO_NAO_PIS_COFINS,     ');
     SQL.Add('       999 AS COD_TAB_SPED,   ');
     SQL.Add('       COALESCE(PRODUTOS.COD_CEST, ''9999999'') AS NUM_CEST,   ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       CLASS_FISCAIS   ');
     SQL.Add('   LEFT JOIN PRODUTOS ON PRODUTOS.COD_CLASS = CLASS_FISCAIS.COD_CLASS   ');
...
procedure TFrmSmPinkCosmGiga.GerarNCMUF;
var
 count, TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarNFClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarNFFornec;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmPinkCosmGiga.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmPinkCosmGiga.GerarNFitensFornec;
var
...
procedure TFrmSmPinkCosmGiga.GerarProdForn;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('           ELSE PRODUTOS.COD_PRODUTO   ');
     SQL.Add('       END AS COD_PRODUTO,   ');
     SQL.Add('       PESSOAS.COD_PESSOA AS COD_FORNECEDOR,   ');
     SQL.Add('               CASE   ');
     SQL.Add('                   WHEN FORNECIMENTOS.COD_PRODUTO_FORNECEDOR IS NULL THEN ''AAA999''   ');
     SQL.Add('                   ELSE REPLACE(REPLACE(REPLACE(FORNECIMENTOS.COD_PRODUTO_FORNECEDOR, ''.'', ''''), ''*'', ''''), ''-'', '''')   ');
     SQL.Add('               END  DES_REFERENCIA,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(PESSOAS.CNPJ_CPF, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,   ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTOS   ');
     SQL.Add('   LEFT JOIN FORNECIMENTOS ON FORNECIMENTOS.COD_PRODUTO = PRODUTOS.COD_PRODUTO   ');
     SQL.Add('   LEFT JOIN PESSOAS ON PESSOAS.COD_PESSOA = FORNECIMENTOS.COD_FORNECEDOR   ');
     SQL.Add('   LEFT JOIN FORNECEDORES ON FORNECEDORES.COD_FORNECEDOR = PESSOAS.COD_PESSOA   ');
     SQL.Add('   WHERE FORNECIMENTOS.COD_EMPRESA = 1   ');
     SQL.Add('   AND PESSOAS.FLAG_FORNECEDOR = 1   ');
     SQL.Add('   AND FORNECEDORES.COD_FORNECEDOR IS NOT NULL   ');
     SQL.Add('   AND PRODUTOS.COD_PRODUTO NOT LIKE ''%BASE TRACTA 0%''   ');
...
procedure TFrmSmPinkCosmGiga.GerarProdLoja;
var
   TotalCount, NEW_CODPROD : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('           ELSE PRODUTOS.COD_PRODUTO         ');
     SQL.Add('       END AS COD_PRODUTO,         ');
     SQL.Add('       COALESCE(P_CUSTO.CUSTO, 0) AS VAL_CUSTO_REP,         ');
     SQL.Add('       COALESCE(P_PRECO.PRECO, 0) AS VAL_VENDA,         ');
     SQL.Add('       0 AS VAL_OFERTA,         ');
     SQL.Add('       COALESCE(P_ESTOQUE.ESTOQUE, 0) AS QTD_EST_VDA,         ');
     ...
     SQL.Add('        ');
     SQL.Add('       CASE         ');
     SQL.Add('           WHEN PRODUTOS.FLAG_ATIVO = 0 THEN ''S''         ');
     SQL.Add('           ELSE ''N''         ');
     ...
     SQL.Add('       SELECT DISTINCT         ');
     SQL.Add('           COD_PRODUTO,         ');
     SQL.Add('           PRECO_CUSTO AS CUSTO         ');
     SQL.Add('       FROM         ');
     SQL.Add('           PRODUTOS_CUSTO         ');
     SQL.Add('       WHERE PRECO_CUSTO <> 0         ');
     SQL.Add('       AND COD_EMPRESA = 1         ');
     SQL.Add('   ) AS P_CUSTO         ');
     SQL.Add('   ON PRODUTOS.COD_PRODUTO = P_CUSTO.COD_PRODUTO         ');
     SQL.Add('   LEFT JOIN(         ');
     SQL.Add('       SELECT DISTINCT         ');                                                      //SELECT
     SQL.Add('           COD_PRODUTO,         ');                                                     //PARA
     SQL.Add('           CAST(REPLACE(VR_VISTA, '','', ''.'') AS NUMERIC(18,5)) AS PRECO   ');        //VALOR
     SQL.Add('       FROM VW_PRODUTOS_BUSCA_PRECO   ');                                               //DE
     SQL.Add('       WHERE VR_VISTA <> ''0''   ');                                                    //VENDA
     SQL.Add('       AND COD_EMPRESA = 1         ');                                                  //
     SQL.Add('       --AND COD_TABELA = 1   ');
     SQL.Add('   ) AS P_PRECO         ');
     SQL.Add('   ON PRODUTOS.COD_PRODUTO = P_PRECO.COD_PRODUTO         ');
     SQL.Add('   LEFT JOIN(         ');
     SQL.Add('       SELECT DISTINCT         ');
     SQL.Add('           COD_PRODUTO,         ');
     SQL.Add('           ESTOQUE AS ESTOQUE         ');
     SQL.Add('       FROM PRODUTOS_SALDOS         ');
     SQL.Add('       WHERE ESTOQUE <> 0         ');
     SQL.Add('       AND COD_EMPRESA = 1         ');
     SQL.Add('   ) AS P_ESTOQUE         ');
     SQL.Add('   ON PRODUTOS.COD_PRODUTO = P_ESTOQUE.COD_PRODUTO         ');
     SQL.Add('   WHERE PRODUTOS.COD_PRODUTO NOT LIKE ''%BASE TRACTA 0%''       ');
...
procedure TFrmSmPinkCosmGiga.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal do
  begin
