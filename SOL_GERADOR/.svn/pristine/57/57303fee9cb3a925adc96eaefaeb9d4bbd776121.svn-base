...
type
  TFrmSmRecantoDoPao = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
var
  FrmSmRecantoDoPao: TFrmSmRecantoDoPao;
  ListNCM    : TStringList;
  TotalCont  : Integer;
  NumLinha : Integer;
  Arquivo: TextFile;
...
procedure TFrmSmRecantoDoPao.GerarProducao;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarProduto;
var
...
procedure TFrmSmRecantoDoPao.GerarScriptAmarrarCEST;
begin
  with QryPrincipal do
  begin
    Close;
...
procedure TFrmSmRecantoDoPao.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmSmRecantoDoPao.GerarSecao;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarSubGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarTransportadora;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmRecantoDoPao.GerarVenda;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmRecantoDoPao.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmRecantoDoPao.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.BtnGerarClick(Sender: TObject);
begin
//  inherited;
...
procedure TFrmSmRecantoDoPao.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.EdtCamBancoExit(Sender: TObject);
begin
  inherited;
  CriarFB(EdtCamBanco);
end;

procedure TFrmSmRecantoDoPao.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmRecantoDoPao.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
...
procedure TFrmSmRecantoDoPao.GerarCest;
var
   TotalCount : integer;
   count : integer;
begin
...
procedure TFrmSmRecantoDoPao.GerarCliente;
//var
...
procedure TFrmSmRecantoDoPao.GerarCodigoBarras;
var
...
procedure TFrmSmRecantoDoPao.GerarComposicao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarCondPagForn;
//var
...
procedure TFrmSmRecantoDoPao.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmRecantoDoPao.GerarFinanceiroPagar(Aberto: String);
var
   TotalCount : Integer;
   cgc: string;
begin
...
procedure TFrmSmRecantoDoPao.GerarFinanceiroReceber(Aberto: String);
var
   TotalCount : Integer;
   cgc : string;
begin
...
procedure TFrmSmRecantoDoPao.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarFornecedor;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(FORNECEDOR.FANTASIA, FORNECEDOR.RAZAOSOCIAL) AS DES_FANTASIA,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(FORNECEDOR.CNPJ, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,   ');
     SQL.Add('       FORNECEDOR.IE AS NUM_INSC_EST,   ');
     SQL.Add('       FORNECEDOR.ENDERECO AS DES_ENDERECO,   ');
     SQL.Add('       COALESCE(FORNECEDOR.BAIRRO, '''') AS DES_BAIRRO,   ');
...
procedure TFrmSmRecantoDoPao.GerarGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarNCM;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('             WHEN PRODUTOS.IMP_ID = 2 AND PRODUTOS.ALIQUOTA = ''0.00'' THEN 4   ');
     SQL.Add('             WHEN PRODUTOS.IMP_ID = 3 AND PRODUTOS.ALIQUOTA = ''0.00'' THEN 1   ');
     SQL.Add('             WHEN PRODUTOS.IMP_ID = 1 AND PRODUTOS.ALIQUOTA = ''20.00'' THEN 29   ');
     SQL.Add('             WHEN PRODUTOS.IMP_ID = 2 AND PRODUTOS.ALIQUOTA = ''20.00'' THEN 43   ');
     SQL.Add('             ELSE 1   ');
...
procedure TFrmSmRecantoDoPao.GerarNCMUF;
var
 count, TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarNFClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarNFFornec;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmRecantoDoPao.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmRecantoDoPao.GerarNFitensFornec;
var
...
procedure TFrmSmRecantoDoPao.GerarProdForn;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   WHERE PRODUTOS.COD_FORNEC > 0 ');
...
procedure TFrmSmRecantoDoPao.GerarProdLoja;
var
   TotalCount, NEW_CODPROD : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('        PRODUTOS.PVENDA2 AS VAL_VENDA_2,   ');
...
procedure TFrmSmRecantoDoPao.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal do
  begin
