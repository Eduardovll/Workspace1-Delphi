...
type
  TFrmSmLaticinioMello = class(TFrmModeloSis)
    btnGeraCest: TButton;
...
var
  FrmSmLaticinioMello: TFrmSmLaticinioMello;
  ListNCM    : TStringList;
  TotalCont  : Integer;
  NumLinha : Integer;
  Arquivo: TextFile;
...
procedure TFrmSmLaticinioMello.GerarProducao;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarProduto;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
       ...
       SQL.Add('              ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.CODBARRA = ''SEM GTIN'' THEN ''''    ');
       //SQL.Add('           WHEN PRODUTO.UNIDADE = ''KG'' THEN ''''   ');
       SQL.Add('           ELSE PRODUTO.CODBARRA    ');
       ...
       SQL.Add('       PRODUTO.ALIQ_IPI AS VAL_IPI,   ');
       SQL.Add('       999 AS COD_SECAO,   ');
       SQL.Add('          ');
//       SQL.Add('       CASE   ');
//       SQL.Add('           WHEN PRODUTO.GRUPO = 0 THEN 999   ');
//       SQL.Add('           ELSE COALESCE(PRODUTO.GRUPO, 999)    ');
       ...
       SQL.Add('          ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.UNIDADE = ''KG'' THEN ''S''   ');
       SQL.Add('           ELSE ''N''   ');
       SQL.Add('       END AS IPV,   ');
       SQL.Add('          ');
       ...
       SQL.Add('      ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 06 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 07 AND PRODUTO.CSTS = 07 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 07 AND PRODUTO.CSTS = 07 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 01 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 01 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 50 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 50 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 53 AND PRODUTO.CSTS = 53 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 70 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 70 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''9.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''18.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 99 AND PRODUTO.CSTS = 99 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''N''   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 99 AND PRODUTO.CSTS = 99 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN ''N''   ');
       SQL.Add('           ELSE ''N''    ');
       SQL.Add('       END AS FLG_NAO_PIS_COFINS,   ');
       SQL.Add('      ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.UNIDADE = ''KG'' THEN ''S''   ');
       SQL.Add('               --PRODUTO.PRODUTO_PESADO = ''S'' OR    ');
       SQL.Add('           ELSE ''N''   ');
       SQL.Add('       END AS FLG_ENVIA_BALANCA,   ');
       SQL.Add('      ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 06 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 07 AND PRODUTO.CSTS = 07 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 07 AND PRODUTO.CSTS = 07 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 01 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 01 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 50 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 50 AND PRODUTO.CSTS = 50 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 53 AND PRODUTO.CSTS = 53 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 70 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 70 AND PRODUTO.CSTS = 70 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''9.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 73 AND PRODUTO.CSTS = 73 AND PRODUTO.ALIQ_PIS = ''18.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN 0   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 99 AND PRODUTO.CSTS = 99 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN -1   ');
       SQL.Add('           WHEN PRODUTO.CSTE = 99 AND PRODUTO.CSTS = 99 AND PRODUTO.ALIQ_PIS = ''1.65'' AND PRODUTO.ALIQ_COF = ''7.60'' THEN -1   ');
       SQL.Add('           ELSE -1    ');
       ...
       SQL.Add('       0 AS NUM_NF,   ');
       SQL.Add('       PRODUTO.DT_CADASTRO AS DTA_ENTRADA,   ');
       SQL.Add('       0 AS COD_NAT_BEM,   ');
       SQL.Add('       0 AS VAL_ORIG_BEM,   ');
       SQL.Add('       PRODUTO.DESCRICAO AS DES_PRODUTO_ANT   ');
       SQL.Add('   FROM   ');
       SQL.Add('       PRODUTO   ');
...
procedure TFrmSmLaticinioMello.GerarScriptAmarrarCEST;
begin
  with QryPrincipal do
  begin
    Close;
...
procedure TFrmSmLaticinioMello.GerarScriptCEST;
var
  codigo : integer;
begin
...
procedure TFrmSmLaticinioMello.GerarSecao;
var
   TotalCount : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTO   ');
//     SQL.Add('   LEFT JOIN MARCA ON MARCA.CODIGO = PRODUTO.FK_MARCA   ');
...
procedure TFrmSmLaticinioMello.GerarSubGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarTransportadora;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       PRODUTO.CODIGO AS COD_PRODUTO,   ');
     SQL.Add('       PRODUTO.PR_VENDA AS VAL_VENDA   ');
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTO   ');
...
procedure TFrmSmLaticinioMello.GerarVenda;
var
   TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmLaticinioMello.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmLaticinioMello.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmLaticinioMello.BtnGerarClick(Sender: TObject);
begin
//  inherited;
...
procedure TFrmSmLaticinioMello.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmLaticinioMello.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmLaticinioMello.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmLaticinioMello.EdtCamBancoExit(Sender: TObject);
begin
  inherited;
  CriarFB(EdtCamBanco);
end;

procedure TFrmSmLaticinioMello.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       PRODUTO.CODIGO AS COD_PRODUTO,   ');
     SQL.Add('       PRODUTO.PR_CUSTO AS VAL_CUSTO_REP   ');
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTO   ');
...
procedure TFrmSmLaticinioMello.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal do
  begin
    ...
    SQL.Add('   SELECT   '); 
    SQL.Add('       PRODUTO.CODIGO AS COD_PRODUTO,   ');
    SQL.Add('       PRODUTO.QTD_ATUAL AS QTD_EST_ATUAL   ');
    SQL.Add('   FROM   '); 
    SQL.Add('       PRODUTO   ');
...
procedure TFrmSmLaticinioMello.GerarCest;
var
   TotalCount : integer;
   count : integer;
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTO.CEST = '''' THEN ''99999999''   ');
     SQL.Add('           ELSE COALESCE(PRODUTO.CEST, ''99999999'')    ');
...
procedure TFrmSmLaticinioMello.GerarCliente;
//var
...
procedure TFrmSmLaticinioMello.GerarCodigoBarras;
var
...
procedure TFrmSmLaticinioMello.GerarComposicao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarCondPagForn;
//var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       PESSOA AS FORNECEDOR   ');
     SQL.Add('   WHERE FORNECEDOR.FORN = ''S''   ');
...
procedure TFrmSmLaticinioMello.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmLaticinioMello.GerarFinanceiroPagar(Aberto: String);
var
   TotalCount : Integer;
   cgc: string;
begin
...
procedure TFrmSmLaticinioMello.GerarFinanceiroReceber(Aberto: String);
var
   TotalCount : Integer;
   cgc : string;
begin
...
procedure TFrmSmLaticinioMello.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarFornecedor;
var
...
//  end;
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('   SELECT   ');
     SQL.Add('       FORNECEDOR.CODIGO AS COD_FORNECEDOR,   ');
     SQL.Add('       FORNECEDOR.RAZAO AS DES_FORNECEDOR,   ');
     SQL.Add('       FORNECEDOR.FANTASIA AS DES_FANTASIA,   ');
     SQL.Add('       COALESCE(REPLACE(REPLACE(REPLACE(FORNECEDOR.CNPJ, ''-'', ''''), ''.'', ''''), ''/'', ''''), '''') AS NUM_CGC,   ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN FORNECEDOR.IE = '''' THEN ''ISENTO''   ');
     SQL.Add('           ELSE COALESCE(FORNECEDOR.IE, ''ISENTO'')   ');
     SQL.Add('       END AS NUM_INSC_EST,   ');
     SQL.Add('      ');
     SQL.Add('       FORNECEDOR.ENDERECO AS DES_ENDERECO,   ');
     SQL.Add('       FORNECEDOR.BAIRRO AS DES_BAIRRO,   ');
     SQL.Add('       COALESCE(FORNECEDOR.MUNICIPIO, ''RIO DE JANEIRO'') AS DES_CIDADE,   ');
     SQL.Add('       COALESCE(FORNECEDOR.UF, ''RJ'') AS DES_SIGLA,   ');
     SQL.Add('       COALESCE(FORNECEDOR.CEP, ''23059-001'') AS NUM_CEP,   ');
     SQL.Add('       COALESCE(FORNECEDOR.FONE1, '''') AS NUM_FONE,   ');
     SQL.Add('       '''' AS NUM_FAX,   ');
     SQL.Add('       FORNECEDOR.FANTASIA AS DES_CONTATO,   ');
     ...
     SQL.Add('       CAST(COALESCE(FORNECEDOR.OBS, FORNECEDOR.COMPLEMENTO) AS VARCHAR(500)) AS DES_OBSERVACAO,   ');
     SQL.Add('       COALESCE(FORNECEDOR.EMAIL1, '''') AS DES_EMAIL,   ');
     ...
     SQL.Add('       ''N'' AS INATIVO,   ');
     SQL.Add('       0 AS COD_CLASSIF,   ');
     SQL.Add('       FORNECEDOR.DT_CADASTRO AS DTA_CADASTRO,   ');
     SQL.Add('       0 AS VAL_CREDITO,   ');
     SQL.Add('       0 AS VAL_DEBITO,   ');
...
procedure TFrmSmLaticinioMello.GerarGrupo;
var
   TotalCount : Integer;
begin
  inherited;
...
//     SQL.Add('           ELSE COALESCE(PRODUTO.GRUPO, 999)    ');
     ...
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTO   ');
//     SQL.Add('   LEFT JOIN GRUPO ON GRUPO.CODIGO = PRODUTO.GRUPO   ');
...
procedure TFrmSmLaticinioMello.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarNCM;
var
...
begin
  ...
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       COALESCE(TAB_NCM.DESCRICAO, ''A DEFINIR'') AS DES_NCM,   ');
     SQL.Add('       CASE WHEN PRODUTO.NCM = ''00000000'' THEN ''99999999'' ELSE PRODUTO.NCM END AS NUM_NCM,   ');
     SQL.Add('          ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTO.CSTE = 06 AND PRODUTO.CSTS = 06 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
     SQL.Add('           WHEN PRODUTO.CSTE = 07 AND PRODUTO.CSTS = 07 AND PRODUTO.ALIQ_PIS = ''0.00'' AND PRODUTO.ALIQ_COF = ''0.00'' THEN ''S''   ');
     ...
     SQL.Add('      ');
     SQL.Add('       CASE   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''000'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 13   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''000'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 4   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''000'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''000'' AND PRODUTO.ALIQ_ICM = ''20.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 40   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''49.99'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''2.00'' AND PRODUTO.REDUCAO_BASE = ''49.99'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''12.00'' AND PRODUTO.REDUCAO_BASE = ''41.67'' THEN 6   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''12.00'' AND PRODUTO.REDUCAO_BASE = ''42.67'' THEN 6   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''12.00'' AND PRODUTO.REDUCAO_BASE = ''49.99'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''12.00'' AND PRODUTO.REDUCAO_BASE = ''61.11'' THEN 41   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 4   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''61.10'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''61.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''81.11'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''020'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND CAST(PRODUTO.REDUCAO_BASE AS VARCHAR(10)) = ''6,111.00'' THEN 8   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''040'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 1   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''041'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 23   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''060'' AND PRODUTO.ALIQ_ICM = ''0.00'' AND PRODUTO.REDUCAO_BASE = ''0.00'' THEN 25   ');
     SQL.Add('           WHEN PRODUTO.CSTICMS = ''060'' AND PRODUTO.ALIQ_ICM = ''18.00'' AND PRODUTO.REDUCAO_BASE = ''61.11'' THEN 17   ');
     SQL.Add('           ELSE 1    ');
     ...
     //SQL.Add('       COALESCE(PRODUTO.COD_BENEFICIO, '''') AS COD_BENEF_FISCAL   ');
     SQL.Add('       CASE PRODUTO.COD_BENEFICIO   ');
     SQL.Add('           WHEN ''RJ801016'' THEN 7   ');
     SQL.Add('   	       WHEN ''RJ802164'' THEN 4   ');
     SQL.Add('   	       WHEN ''RJ802266'' THEN 13   ');
     SQL.Add('   	       WHEN ''RJ802420'' THEN 20   ');
//     SQL.Add('           WHEN ''RJ402164'' THEN  ');
//     SQL.Add('           WHEN ''RJ802154'' THEN  ');
     SQL.Add('           ELSE ''''   ');
     SQL.Add('       END AS COD_BENEFICIO_FISCAL,   ');
     SQL.Add('      ');
     SQL.Add('       CASE PRODUTO.COD_BENEFICIO   ');
     SQL.Add('           WHEN ''RJ801016'' THEN 7   ');
     SQL.Add('           WHEN ''RJ802164'' THEN 4   ');
     ...
     SQL.Add('           WHEN ''RJ802420'' THEN 20   ');
     SQL.Add('           ELSE ''''   ');
     SQL.Add('       END AS COD_BENEFICIO_FISCAL_ENT   ');
     SQL.Add('   FROM   ');
     SQL.Add('       PRODUTO   ');
     SQL.Add('   LEFT JOIN IBPT AS TAB_NCM ON TAB_NCM.CODIGO = PRODUTO.NCM  ');
...
procedure TFrmSmLaticinioMello.GerarNCMUF;
var
 count, TotalCount : Integer;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarNFClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarNFFornec;
var
   TotalCount : integer;
begin
  inherited;
...
procedure TFrmSmLaticinioMello.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal do
  begin
...
procedure TFrmSmLaticinioMello.GerarNFitensFornec;
var
...
procedure TFrmSmLaticinioMello.GerarProdForn;
var
...
procedure TFrmSmLaticinioMello.GerarProdLoja;
var
   TotalCount, NEW_CODPROD : integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
       ...
       SQL.Add('       PRODUTO.QTD_ATUAL AS QTD_EST_VDA,   ');
       ...
       SQL.Add('          ');
       SQL.Add('       CASE   ');
       SQL.Add('           WHEN PRODUTO.ATIVO = ''N'' THEN ''S''   ');
       SQL.Add('           ELSE ''N''   ');
       ...
       SQL.Add('       PRODUTO.QTD_MIN AS QTD_EST_MINIMO,   ');
       ...
       SQL.Add('       END AS NUM_CEST,   ');
       SQL.Add('          ');
       SQL.Add('       PRODUTO.MVA AS PER_IVA,   ');
       SQL.Add('       0 AS PER_FCP_ST,   ');
...
procedure TFrmSmLaticinioMello.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal do
  begin
