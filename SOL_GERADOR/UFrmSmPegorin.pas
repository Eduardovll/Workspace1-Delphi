...
type
  TFrmSmPegorin = class(TFrmModeloSis)
    CbxLoja: TComboBox;
    lblLoja: TLabel;
...
procedure TFrmSmPegorin.GerarProducao;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarProduto;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarSecao;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarSubGrupo;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarValorVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmPegorin.GerarVenda;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('           WHEN PRODUTOS.TRI_CODIGO = 11 THEN 20   ');
     SQL.Add('           WHEN PRODUTOS.TRI_CODIGO = 12 THEN 23   ');
     SQL.Add('           WHEN PRODUTOS.TRI_CODIGO = 13 THEN 27   ');
     SQL.Add('           WHEN PRODUTOS.TRI_CODIGO = 14 THEN 37   ');
     SQL.Add('           WHEN PRODUTOS.TRI_CODIGO = 15 THEN 41   ');
...
procedure TFrmSmPegorin.BtnAmarrarCestClick(Sender: TObject);
begin
  inherited;
    inherited;
...
procedure TFrmSmPegorin.btnGeraCestClick(Sender: TObject);
begin
  inherited;
  FlgGeraCest := True;
  BtnGerar.Click;
...
procedure TFrmSmPegorin.btnGeraCustoRepClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPegorin.BtnGerarClick(Sender: TObject);
begin
...
procedure TFrmSmPegorin.btnGerarEstoqueAtualClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPegorin.btnGeraValorVendaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPegorin.CkbProdLojaClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPegorin.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFrmSmPegorin.GeraCustoRep;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmPegorin.GeraEstoqueVenda;
var
  COD_PRODUTO : string;
begin
  with QryPrincipal2 do
...
procedure TFrmSmPegorin.GerarCest;
var
   count : integer;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarCliente;
begin
...
procedure TFrmSmPegorin.GerarCodigoBarras;
var
...
procedure TFrmSmPegorin.GerarComposicao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarCondPagCli;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarCondPagForn;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarDecomposicao;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarDivisaoForn;
begin
  inherited;
    with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarFinanceiro(Tipo, Situacao: Integer);
begin
  inherited;
  if Tipo = 1 then
...
procedure TFrmSmPegorin.GerarFinanceiroPagar(Aberto: String);
var
  NUM_DOCTO : string;
...
procedure TFrmSmPegorin.GerarFinanceiroReceber(Aberto: String);
var
   codParceiro : Integer;
   numDocto : String;
   count : integer;
...
procedure TFrmSmPegorin.GerarFinanceiroReceberCartao;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarFornecedor;
var
...
procedure TFrmSmPegorin.GerarGrupo;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarInfoNutricionais;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarNCM;
var
 count : Integer;
begin
  inherited;
  ...
  begin
    ...
    SQL.Clear;
       ...
       SQL.Add('           WHEN PRODUTOS.TRI_ENTRADA = 11 THEN 20   ');
       SQL.Add('           WHEN PRODUTOS.TRI_ENTRADA = 12 THEN 23   ');
       SQL.Add('           WHEN PRODUTOS.TRI_ENTRADA = 13 THEN 27   ');
       SQL.Add('           WHEN PRODUTOS.TRI_ENTRADA = 14 THEN 37   ');
       SQL.Add('           WHEN PRODUTOS.TRI_ENTRADA = 15 THEN 41   ');
...
procedure TFrmSmPegorin.GerarNCMUF;
var
 count : Integer;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarNFClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarNFFornec;
begin
  inherited;
  with QryPrincipal2 do
  begin
...
procedure TFrmSmPegorin.GerarNFitensClientes;
begin
  inherited;
  with QryPrincipal2 do
  begin
    ...
    SQL.Clear;
     ...
     SQL.Add('       ITENS.PRO_TOTAL AS VAL_TABELA,   ');
     ...
     SQL.Add('       COALESCE(ITENS.PRO_VENDA, 0) AS VAL_TABELA_LIQ,   ');
...
procedure TFrmSmPegorin.GerarNFitensFornec;
var
...
procedure TFrmSmPegorin.GerarProdForn;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarProdLoja;
var
  count, count1 : Integer;
begin
  inherited;
...
procedure TFrmSmPegorin.GerarProdSimilar;
begin
  inherited;
  with QryPrincipal2 do
  begin
