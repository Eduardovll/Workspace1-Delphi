...
begin
 with Layout do
 begin
  Layout := TLayout.Create('Condição Pagamento Fornecedor','CONDICAO_FORNECEDOR');
...
begin
 with Layout do
 begin
    Layout := TLayout.Create('Divisão Fornecedor','DIVISAO_FORNECEDOR');
    AddField('COD_FORNECEDOR',10,'0',tpLeft,ftpInteger);
...
begin
 with Layout do
 begin
    Layout := TLayout.Create('Endereço Cobrança Cliente','CLIENTE_COBRANCA');
    AddField('COD_CLIENTE',10,'0',tpLeft,FtpInteger);
    AddField('DES_ENDERECO',50,' ',tpRight,FtpString);
...
begin
 ...
 begin
  Layout := TLayout.Create('Fornecedores','FORNECEDOR');
    ...
    AddField('COD_CONTA',25,' ',tpRight,FtpString);
    AddField('INATIVO',1,' ',tpRight,FtpString);
    ...
    AddField('DES_EMAIL_VEND',70,' ',tpRight,FtpString);
    AddField('SENHA_COTACAO',8,' ',tpRight,FtpString);
    AddField('TIPO_PRODUTOR',1,' ',tpRight,FtpString);
    AddField('NUM_CELULAR',15,' ',tpLeft,FtpString);
    AddField('FLG_RECEB_SEM_PEDIDO',1,' ',tpRight,FtpString);
    AddField('COD_BANCOFORN',10,' ',tpRight,FtpString);
    AddField('COD_AGENCIAFORN',25,' ',tpRight,FtpString);
    AddField('COD_DIGAGFORN',5,' ',tpRight,FtpString);
    AddField('COD_CONTACCFORN',25,' ',tpRight,FtpString);
    AddField('COD_DIGCCFORN',5,' ',tpRight,FtpString);
 end;
 Result := Layout;
end;
...
begin
 with Layout do
 begin
  Layout     := TLayout.Create('Condição Pagamento Cliente','CONDICAO_CLIENTE');
  AddField('COD_CLIENTE',10,'0',tpLeft,FtpInteger);
  AddField('NUM_CONDICAO',10,'0',tpLeft,FtpInteger);
  AddField('COD_CONDICAO',10,'0',tpLeft,FtpInteger);
  AddField('COD_ENTIDADE',10,'0',tpLeft,FtpInteger);
