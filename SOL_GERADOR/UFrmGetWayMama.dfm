inherited FrmGetWayMama: TFrmGetWayMama
  Caption = 'SUPERMERCADO MAMA'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited PctArquivos: TPageControl
    ...
    inherited AbaFiscal: TTabSheet
      ...
      ExplicitWidth = 257
      ExplicitHeight = 297
      inherited CkbNFFornec: TCheckBox
        Enabled = False
      end
  ...
  object ADOSQLServer: TADOConnection
    ConnectionString = 'Provider=MSDASQL.1;Persist Security Info=False;Data Source=teste'
    LoginPrompt = False
    Provider = 'MSDASQL.1'
    Left = 560
    Top = 8
