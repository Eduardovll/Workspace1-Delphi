...
begin
 with Layout do
 begin
  Layout := TLayout.Create('Código de Barras','CODIGO_BARRA');
...
begin
 with Layout do
 begin
  Layout  := TLayout.Create('Composição Produto','COMPOSICAO');
...
begin
 with Layout do
 begin
  Layout := TLayout.Create('DecomPosição Produto','DECOMPOSICAO');
  AddField('COD_PRODUTO',13 ,'0',tpLeft, ftpInteger );
...
begin
 with Layout do
 begin
  Layout := TLayout.Create('Informações Nutricionais','INFO_NUTRICIONAL');
...
begin
 ...
 begin
  ...
  AddField('COD_TRIB_ENTRADA',4 ,'0',tpLeft, ftpString );
  AddField('COD_TRIB_SAIDA',4 ,'0',tpLeft, ftpString );
...
begin
 with Layout do
 begin
   Layout := TLayout.Create('Produto Produção', 'PRODUCAO');
   AddField('COD_PRODUTO',8 ,'0',tpLeft, ftpString );
...
begin
   with Layout do
   begin
    Layout := TLayout.Create('Localização Produtos','LOCALIZACAO');
...
begin
   ...
   begin
     ...
     AddField('COD_TRIB_ENTRADA',10 ,'0',tpLeft, ftpString );
...
begin
   ...
   begin
    ...
    AddField('DETALHAMENTO',700 , ' ',tpRight, ftpString);
   end;
   Result := Layout;
end;
...
begin
   with Layout do
   begin
    Layout := TLayout.Create('Seção','SECAO');
    AddField('COD_SECAO',10 ,'0',tpLeft, ftpString );
